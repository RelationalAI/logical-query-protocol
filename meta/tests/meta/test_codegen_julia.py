...
def test_julia_visit_nonterminal_def_generation():
    ...
    code = gen.generate_def(parse_def)
    assert (
        "function parse_expr(parser::ParserState, context::String)::Proto.Expr" in code
    )
...
def test_julia_empty_string_literal():
...
def test_julia_deeply_nested_calls():
...
def test_julia_long_variable_name():
...
def test_julia_two_element_seq():
...
def test_julia_option_none_lit():
...
if __name__ == "__main__":
    ...
    test_julia_and_short_circuit_with_side_effects()
    test_julia_or_short_circuit_with_side_effects()
    test_julia_and_without_side_effects_uses_template()
    test_julia_or_without_side_effects_uses_template()
    test_julia_empty_string_literal()
    test_julia_deeply_nested_calls()
    test_julia_long_variable_name()
    test_julia_nested_if_else()
    test_julia_two_element_seq()
    test_julia_option_none_lit()
