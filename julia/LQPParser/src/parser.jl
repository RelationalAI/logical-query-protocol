...
function construct_csv_config(parser::Parser, config_dict::Vector{Tuple{String, Proto.Value}})::Proto.CSVConfig
    ...
    skip = _t947
    _t948 = _extract_value_string(parser, get(config, "csv_new_line", nothing), "")
    new_line = _t948
    _t949 = _extract_value_string(parser, get(config, "csv_delimiter", nothing), ",")
    delimiter = _t949
    _t950 = _extract_value_string(parser, get(config, "csv_quotechar", nothing), "\"")
    quotechar = _t950
    _t951 = _extract_value_string(parser, get(config, "csv_escapechar", nothing), "\"")
    escapechar = _t951
    _t952 = _extract_value_string(parser, get(config, "csv_comment", nothing), "")
    comment = _t952
    _t953 = _extract_value_string_list(parser, get(config, "csv_missing_strings", nothing), String[])
    missing_strings = _t953
    _t954 = _extract_value_string(parser, get(config, "csv_decimal_separator", nothing), ".")
    decimal_separator = _t954
    _t955 = _extract_value_string(parser, get(config, "csv_encoding", nothing), "utf-8")
    encoding = _t955
    _t956 = _extract_value_string(parser, get(config, "csv_compression", nothing), "auto")
    compression = _t956
    _t957 = Proto.CSVConfig(Int32(header_row), skip, new_line, delimiter, quotechar, escapechar, comment, missing_strings, decimal_separator, encoding, compression)
    return _t957
end
...
function construct_betree_info(parser::Parser, key_types::Vector{Proto.var"#Type"}, value_types::Vector{Proto.var"#Type"}, config_dict::Vector{Tuple{String, Proto.Value}})::Proto.BeTreeInfo
    config = Dict(config_dict)
    _t958 = _try_extract_value_float64(parser, get(config, "betree_config_epsilon", nothing))
    epsilon = _t958
    _t959 = _try_extract_value_int64(parser, get(config, "betree_config_max_pivots", nothing))
    max_pivots = _t959
    _t960 = _try_extract_value_int64(parser, get(config, "betree_config_max_deltas", nothing))
    max_deltas = _t960
    _t961 = _try_extract_value_int64(parser, get(config, "betree_config_max_leaf", nothing))
    max_leaf = _t961
    _t962 = Proto.BeTreeConfig(epsilon, max_pivots, max_deltas, max_leaf)
    storage_config = _t962
    _t963 = _try_extract_value_uint128(parser, get(config, "betree_locator_root_pageid", nothing))
    root_pageid = _t963
    _t964 = _try_extract_value_bytes(parser, get(config, "betree_locator_inline_data", nothing))
    inline_data = _t964
    _t965 = _try_extract_value_int64(parser, get(config, "betree_locator_element_count", nothing))
    element_count = _t965
    _t966 = _try_extract_value_int64(parser, get(config, "betree_locator_tree_height", nothing))
    tree_height = _t966
    _t967 = Proto.BeTreeLocator((!isnothing(root_pageid) ? OneOf(:root_pageid, root_pageid) : (!isnothing(inline_data) ? OneOf(:inline_data, inline_data) : nothing)), element_count, tree_height)
    relation_locator = _t967
    _t968 = Proto.BeTreeInfo(key_types, value_types, storage_config, relation_locator)
    return _t968
end

function default_configure(parser::Parser)::Proto.Configure
    _t969 = Proto.IVMConfig(Proto.MaintenanceLevel.MAINTENANCE_LEVEL_OFF)
    ivm_config = _t969
    _t970 = Proto.Configure(0, ivm_config)
    return _t970
end
...
function export_csv_config(parser::Parser, path::String, columns::Vector{Proto.ExportCSVColumn}, config_dict::Vector{Tuple{String, Proto.Value}})::Proto.ExportCSVConfig
    ...
    _t981 = Proto.ExportCSVConfig(path, columns, partition_size, compression, syntax_header_row, syntax_missing_string, syntax_delim, syntax_quotechar, syntax_escapechar)
    return _t981
end
...
function parse_transaction(parser::Parser)::Proto.Transaction
    ...
    _t359 = Proto.Transaction(epochs5, (!isnothing(configure0) ? configure0 : _t358), sync1)
    return _t359
end
...
function parse_value(parser::Parser)::Proto.Value
    ...
    if prediction13 == 9
        ...
        _t378 = Proto.Value(OneOf(:boolean_value, boolean_value22))
        _t376 = _t378
    else
        ...
        if prediction13 == 8
            ...
            _t381 = Proto.Value(OneOf(:missing_value, _t380))
            _t379 = _t381
        else
            
            if prediction13 == 7
                decimal21 = consume_terminal!(parser, "DECIMAL")
                _t383 = Proto.Value(OneOf(:decimal_value, decimal21))
                _t382 = _t383
            else
                
                if prediction13 == 6
                    int12820 = consume_terminal!(parser, "INT128")
                    _t385 = Proto.Value(OneOf(:int128_value, int12820))
                    _t384 = _t385
                else
                    
                    if prediction13 == 5
                        uint12819 = consume_terminal!(parser, "UINT128")
                        _t387 = Proto.Value(OneOf(:uint128_value, uint12819))
                        _t386 = _t387
                    else
                        
                        if prediction13 == 4
                            float18 = consume_terminal!(parser, "FLOAT")
                            _t389 = Proto.Value(OneOf(:float_value, float18))
                            _t388 = _t389
                        else
                            
                            if prediction13 == 3
                                int17 = consume_terminal!(parser, "INT")
                                _t391 = Proto.Value(OneOf(:int_value, int17))
                                _t390 = _t391
                            else
                                
                                if prediction13 == 2
                                    string16 = consume_terminal!(parser, "STRING")
                                    _t393 = Proto.Value(OneOf(:string_value, string16))
                                    _t392 = _t393
                                else
                                    ...
                                    if prediction13 == 1
                                        ...
                                        datetime15 = _t395
                                        _t396 = Proto.Value(OneOf(:datetime_value, datetime15))
                                        _t394 = _t396
                                    else
                                        ...
                                        if prediction13 == 0
                                            ...
                                            date14 = _t398
                                            _t399 = Proto.Value(OneOf(:date_value, date14))
                                            _t397 = _t399
                                        else
...
function parse_date(parser::Parser)::Proto.DateValue
    ...
    consume_literal!(parser, ")")
    _t400 = Proto.DateValue(Int32(int23), Int32(int_324), Int32(int_425))
    return _t400
end
...
function parse_datetime(parser::Parser)::Proto.DateTimeValue
    ...
    int_832 = _t401
    consume_literal!(parser, ")")
    _t402 = Proto.DateTimeValue(Int32(int26), Int32(int_327), Int32(int_428), Int32(int_529), Int32(int_630), Int32(int_731), Int32((!isnothing(int_832) ? int_832 : 0)))
    return _t402
end
...
function parse_sync(parser::Parser)::Proto.Sync
    ...
    fragment_ids37 = xs34
    consume_literal!(parser, ")")
    _t408 = Proto.Sync(fragment_ids37)
    return _t408
end
...
function parse_epoch(parser::Parser)::Proto.Epoch
    ...
    epoch_reads40 = _t411
    consume_literal!(parser, ")")
    _t413 = Proto.Epoch((!isnothing(epoch_writes39) ? epoch_writes39 : Proto.Write[]), (!isnothing(epoch_reads40) ? epoch_reads40 : Proto.Read[]))
    return _t413
end
...
function parse_write(parser::Parser)::Proto.Write
    ...
    if prediction45 == 2
        ...
        context48 = _t420
        _t421 = Proto.Write(OneOf(:context, context48))
        _t419 = _t421
    else
        ...
        if prediction45 == 1
            ...
            undefine47 = _t423
            _t424 = Proto.Write(OneOf(:undefine, undefine47))
            _t422 = _t424
        else
            ...
            if prediction45 == 0
                ...
                define46 = _t426
                _t427 = Proto.Write(OneOf(:define, define46))
                _t425 = _t427
            else
...
function parse_declaration(parser::Parser)::Proto.Declaration
    ...
    if prediction56 == 3
        ...
        data60 = _t441
        _t442 = Proto.Declaration(OneOf(:data, data60))
        _t440 = _t442
    else
        ...
        if prediction56 == 2
            ...
            constraint59 = _t444
            _t445 = Proto.Declaration(OneOf(:constraint, constraint59))
            _t443 = _t445
        else
            ...
            if prediction56 == 1
                ...
                algorithm58 = _t447
                _t448 = Proto.Declaration(OneOf(:algorithm, algorithm58))
                _t446 = _t448
            else
                ...
                if prediction56 == 0
                    ...
                    def57 = _t450
                    _t451 = Proto.Declaration(OneOf(:def, def57))
                    _t449 = _t451
                else
...
function parse_def(parser::Parser)::Proto.Def
    ...
    attrs63 = _t454
    consume_literal!(parser, ")")
    _t456 = Proto.Def(relation_id61, abstraction62, (!isnothing(attrs63) ? attrs63 : Proto.Attribute[]))
    return _t456
end
...
function parse_abstraction(parser::Parser)::Proto.Abstraction
    ...
    formula68 = _t462
    consume_literal!(parser, ")")
    _t463 = Proto.Abstraction(vcat(bindings67[1], !isnothing(bindings67[2]) ? bindings67[2] : []), formula68)
    return _t463
end
...
function parse_binding(parser::Parser)::Proto.Binding
    ...
    type75 = _t467
    _t468 = Proto.Var(symbol74)
    _t469 = Proto.Binding(_t468, type75)
    return _t469
end
...
function parse_type(parser::Parser)::Proto.var"#Type"
    ...
    if prediction76 == 10
        ...
        _t483 = Proto.var"#Type"(OneOf(:boolean_type, boolean_type87))
        _t481 = _t483
    else
        ...
        if prediction76 == 9
            ...
            _t486 = Proto.var"#Type"(OneOf(:decimal_type, decimal_type86))
            _t484 = _t486
        else
            ...
            if prediction76 == 8
                ...
                _t489 = Proto.var"#Type"(OneOf(:missing_type, missing_type85))
                _t487 = _t489
            else
                ...
                if prediction76 == 7
                    ...
                    _t492 = Proto.var"#Type"(OneOf(:datetime_type, datetime_type84))
                    _t490 = _t492
                else
                    ...
                    if prediction76 == 6
                        ...
                        date_type83 = _t494
                        _t495 = Proto.var"#Type"(OneOf(:date_type, date_type83))
                        _t493 = _t495
                    else
                        ...
                        if prediction76 == 5
                            ...
                            int128_type82 = _t497
                            _t498 = Proto.var"#Type"(OneOf(:int128_type, int128_type82))
                            _t496 = _t498
                        else
                            ...
                            if prediction76 == 4
                                ...
                                _t501 = Proto.var"#Type"(OneOf(:uint128_type, uint128_type81))
                                _t499 = _t501
                            else
                                ...
                                if prediction76 == 3
                                    ...
                                    float_type80 = _t503
                                    _t504 = Proto.var"#Type"(OneOf(:float_type, float_type80))
                                    _t502 = _t504
                                else
                                    ...
                                    if prediction76 == 2
                                        ...
                                        int_type79 = _t506
                                        _t507 = Proto.var"#Type"(OneOf(:int_type, int_type79))
                                        _t505 = _t507
                                    else
                                        ...
                                        if prediction76 == 1
                                            ...
                                            string_type78 = _t509
                                            _t510 = Proto.var"#Type"(OneOf(:string_type, string_type78))
                                            _t508 = _t510
                                        else
                                            ...
                                            if prediction76 == 0
                                                ...
                                                _t513 = Proto.var"#Type"(OneOf(:unspecified_type, unspecified_type77))
                                                _t511 = _t513
                                            else
...
function parse_decimal_type(parser::Parser)::Proto.DecimalType
    ...
    consume_literal!(parser, ")")
    _t523 = Proto.DecimalType(Int32(int88), Int32(int_389))
    return _t523
end
...
function parse_formula(parser::Parser)::Proto.Formula
    ...
    if prediction94 == 12
        ...
        cast107 = _t550
        _t551 = Proto.Formula(OneOf(:cast, cast107))
        _t549 = _t551
    else
        ...
        if prediction94 == 11
            ...
            rel_atom106 = _t553
            _t554 = Proto.Formula(OneOf(:rel_atom, rel_atom106))
            _t552 = _t554
        else
            ...
            if prediction94 == 10
                ...
                primitive105 = _t556
                _t557 = Proto.Formula(OneOf(:primitive, primitive105))
                _t555 = _t557
            else
                ...
                if prediction94 == 9
                    ...
                    pragma104 = _t559
                    _t560 = Proto.Formula(OneOf(:pragma, pragma104))
                    _t558 = _t560
                else
                    ...
                    if prediction94 == 8
                        ...
                        atom103 = _t562
                        _t563 = Proto.Formula(OneOf(:atom, atom103))
                        _t561 = _t563
                    else
                        ...
                        if prediction94 == 7
                            ...
                            ffi102 = _t565
                            _t566 = Proto.Formula(OneOf(:ffi, ffi102))
                            _t564 = _t566
                        else
                            ...
                            if prediction94 == 6
                                ...
                                not101 = _t568
                                _t569 = Proto.Formula(OneOf(:not, not101))
                                _t567 = _t569
                            else
                                ...
                                if prediction94 == 5
                                    ...
                                    _t572 = Proto.Formula(OneOf(:disjunction, disjunction100))
                                    _t570 = _t572
                                else
                                    ...
                                    if prediction94 == 4
                                        ...
                                        conjunction99 = _t574
                                        _t575 = Proto.Formula(OneOf(:conjunction, conjunction99))
                                        _t573 = _t575
                                    else
                                        ...
                                        if prediction94 == 3
                                            ...
                                            reduce98 = _t577
                                            _t578 = Proto.Formula(OneOf(:reduce, reduce98))
                                            _t576 = _t578
                                        else
                                            ...
                                            if prediction94 == 2
                                                ...
                                                exists97 = _t580
                                                _t581 = Proto.Formula(OneOf(:exists, exists97))
                                                _t579 = _t581
                                            else
                                                ...
                                                if prediction94 == 1
                                                    ...
                                                    false96 = _t583
                                                    _t584 = Proto.Formula(OneOf(:disjunction, false96))
                                                    _t582 = _t584
                                                else
                                                    ...
                                                    if prediction94 == 0
                                                        ...
                                                        true95 = _t586
                                                        _t587 = Proto.Formula(OneOf(:conjunction, true95))
                                                        _t585 = _t587
                                                    else
...
function parse_true(parser::Parser)::Proto.Conjunction
    ...
    consume_literal!(parser, "true")
    consume_literal!(parser, ")")
    _t588 = Proto.Conjunction(Proto.Formula[])
    return _t588
end
...
function parse_false(parser::Parser)::Proto.Disjunction
    ...
    consume_literal!(parser, "false")
    consume_literal!(parser, ")")
    _t589 = Proto.Disjunction(Proto.Formula[])
    return _t589
end
...
function parse_exists(parser::Parser)::Proto.Exists
    ...
    formula109 = _t591
    consume_literal!(parser, ")")
    _t592 = Proto.Abstraction(vcat(bindings108[1], !isnothing(bindings108[2]) ? bindings108[2] : []), formula109)
    _t593 = Proto.Exists(_t592)
    return _t593
end
...
function parse_reduce(parser::Parser)::Proto.Reduce
    ...
    terms112 = _t596
    consume_literal!(parser, ")")
    _t597 = Proto.Reduce(abstraction110, abstraction_3111, terms112)
    return _t597
end
...
function parse_term(parser::Parser)::Proto.Term
    ...
    if prediction117 == 1
        ...
        constant119 = _t611
        _t612 = Proto.Term(OneOf(:constant, constant119))
        _t610 = _t612
    else
        ...
        if prediction117 == 0
            ...
            var118 = _t614
            _t615 = Proto.Term(OneOf(:var, var118))
            _t613 = _t615
        else
...
function parse_conjunction(parser::Parser)::Proto.Conjunction
    ...
    formulas125 = xs122
    consume_literal!(parser, ")")
    _t619 = Proto.Conjunction(formulas125)
    return _t619
end
...
function parse_disjunction(parser::Parser)::Proto.Disjunction
    ...
    formulas129 = xs126
    consume_literal!(parser, ")")
    _t621 = Proto.Disjunction(formulas129)
    return _t621
end
...
function parse_ffi(parser::Parser)::Proto.FFI
    ...
    terms133 = _t626
    consume_literal!(parser, ")")
    _t627 = Proto.FFI(name131, ffi_args132, terms133)
    return _t627
end
...
function parse_atom(parser::Parser)::Proto.Atom
    ...
    terms143 = xs140
    consume_literal!(parser, ")")
    _t631 = Proto.Atom(relation_id139, terms143)
    return _t631
end
...
function parse_pragma(parser::Parser)::Proto.Pragma
    ...
    terms148 = xs145
    consume_literal!(parser, ")")
    _t634 = Proto.Pragma(name144, terms148)
    return _t634
end
...
function parse_primitive(parser::Parser)::Proto.Primitive
    ...
    if prediction149 == 9
        ...
        rel_terms163 = xs160
        consume_literal!(parser, ")")
        _t649 = Proto.Primitive(name159, rel_terms163)
        _t646 = _t649
    else
...
function parse_eq(parser::Parser)::Proto.Primitive
    ...
    term_3165 = _t669
    consume_literal!(parser, ")")
    _t670 = Proto.RelTerm(OneOf(:term, term164))
    _t671 = Proto.RelTerm(OneOf(:term, term_3165))
    _t672 = Proto.Primitive("rel_primitive_eq", Proto.RelTerm[_t670, _t671])
    return _t672
end
...
function parse_lt(parser::Parser)::Proto.Primitive
    ...
    term_3167 = _t674
    consume_literal!(parser, ")")
    _t675 = Proto.RelTerm(OneOf(:term, term166))
    _t676 = Proto.RelTerm(OneOf(:term, term_3167))
    _t677 = Proto.Primitive("rel_primitive_lt_monotype", Proto.RelTerm[_t675, _t676])
    return _t677
end
...
function parse_lt_eq(parser::Parser)::Proto.Primitive
    ...
    term_3169 = _t679
    consume_literal!(parser, ")")
    _t680 = Proto.RelTerm(OneOf(:term, term168))
    _t681 = Proto.RelTerm(OneOf(:term, term_3169))
    _t682 = Proto.Primitive("rel_primitive_lt_eq_monotype", Proto.RelTerm[_t680, _t681])
    return _t682
end
...
function parse_gt(parser::Parser)::Proto.Primitive
    ...
    term_3171 = _t684
    consume_literal!(parser, ")")
    _t685 = Proto.RelTerm(OneOf(:term, term170))
    _t686 = Proto.RelTerm(OneOf(:term, term_3171))
    _t687 = Proto.Primitive("rel_primitive_gt_monotype", Proto.RelTerm[_t685, _t686])
    return _t687
end
...
function parse_gt_eq(parser::Parser)::Proto.Primitive
    ...
    term_3173 = _t689
    consume_literal!(parser, ")")
    _t690 = Proto.RelTerm(OneOf(:term, term172))
    _t691 = Proto.RelTerm(OneOf(:term, term_3173))
    _t692 = Proto.Primitive("rel_primitive_gt_eq_monotype", Proto.RelTerm[_t690, _t691])
    return _t692
end
...
function parse_add(parser::Parser)::Proto.Primitive
    ...
    term_4176 = _t695
    consume_literal!(parser, ")")
    _t696 = Proto.RelTerm(OneOf(:term, term174))
    _t697 = Proto.RelTerm(OneOf(:term, term_3175))
    _t698 = Proto.RelTerm(OneOf(:term, term_4176))
    _t699 = Proto.Primitive("rel_primitive_add_monotype", Proto.RelTerm[_t696, _t697, _t698])
    return _t699
end
...
function parse_minus(parser::Parser)::Proto.Primitive
    ...
    term_4179 = _t702
    consume_literal!(parser, ")")
    _t703 = Proto.RelTerm(OneOf(:term, term177))
    _t704 = Proto.RelTerm(OneOf(:term, term_3178))
    _t705 = Proto.RelTerm(OneOf(:term, term_4179))
    _t706 = Proto.Primitive("rel_primitive_subtract_monotype", Proto.RelTerm[_t703, _t704, _t705])
    return _t706
end
...
function parse_multiply(parser::Parser)::Proto.Primitive
    ...
    term_4182 = _t709
    consume_literal!(parser, ")")
    _t710 = Proto.RelTerm(OneOf(:term, term180))
    _t711 = Proto.RelTerm(OneOf(:term, term_3181))
    _t712 = Proto.RelTerm(OneOf(:term, term_4182))
    _t713 = Proto.Primitive("rel_primitive_multiply_monotype", Proto.RelTerm[_t710, _t711, _t712])
    return _t713
end
...
function parse_divide(parser::Parser)::Proto.Primitive
    ...
    term_4185 = _t716
    consume_literal!(parser, ")")
    _t717 = Proto.RelTerm(OneOf(:term, term183))
    _t718 = Proto.RelTerm(OneOf(:term, term_3184))
    _t719 = Proto.RelTerm(OneOf(:term, term_4185))
    _t720 = Proto.Primitive("rel_primitive_divide_monotype", Proto.RelTerm[_t717, _t718, _t719])
    return _t720
end
...
function parse_rel_term(parser::Parser)::Proto.RelTerm
    ...
    if prediction186 == 1
        ...
        term188 = _t734
        _t735 = Proto.RelTerm(OneOf(:term, term188))
        _t733 = _t735
    else
        ...
        if prediction186 == 0
            ...
            _t738 = Proto.RelTerm(OneOf(:specialized_value, specialized_value187))
            _t736 = _t738
        else
...
function parse_rel_atom(parser::Parser)::Proto.RelAtom
    ...
    rel_terms194 = xs191
    consume_literal!(parser, ")")
    _t742 = Proto.RelAtom(name190, rel_terms194)
    return _t742
end
...
function parse_cast(parser::Parser)::Proto.Cast
    ...
    term_3196 = _t744
    consume_literal!(parser, ")")
    _t745 = Proto.Cast(term195, term_3196)
    return _t745
end
...
function parse_attribute(parser::Parser)::Proto.Attribute
    ...
    values205 = xs202
    consume_literal!(parser, ")")
    _t749 = Proto.Attribute(name201, values205)
    return _t749
end
...
function parse_algorithm(parser::Parser)::Proto.Algorithm
    ...
    script210 = _t751
    consume_literal!(parser, ")")
    _t752 = Proto.Algorithm(relation_ids209, script210)
    return _t752
end
...
function parse_script(parser::Parser)::Proto.Script
    ...
    constructs214 = xs211
    consume_literal!(parser, ")")
    _t754 = Proto.Script(constructs214)
    return _t754
end
...
function parse_construct(parser::Parser)::Proto.Construct
    ...
    if prediction215 == 1
        ...
        _t764 = Proto.Construct(OneOf(:instruction, instruction217))
        _t762 = _t764
    else
        ...
        if prediction215 == 0
            ...
            loop216 = _t766
            _t767 = Proto.Construct(OneOf(:loop, loop216))
            _t765 = _t767
        else
...
function parse_loop(parser::Parser)::Proto.Loop
    ...
    script219 = _t769
    consume_literal!(parser, ")")
    _t770 = Proto.Loop(init218, script219)
    return _t770
end
...
function parse_instruction(parser::Parser)::Proto.Instruction
    ...
    if prediction224 == 4
        ...
        monus_def229 = _t779
        _t780 = Proto.Instruction(OneOf(:monus_def, monus_def229))
        _t778 = _t780
    else
        ...
        if prediction224 == 3
            ...
            monoid_def228 = _t782
            _t783 = Proto.Instruction(OneOf(:monoid_def, monoid_def228))
            _t781 = _t783
        else
            ...
            if prediction224 == 2
                ...
                break227 = _t785
                _t786 = Proto.Instruction(OneOf(:var"#break", break227))
                _t784 = _t786
            else
                ...
                if prediction224 == 1
                    ...
                    upsert226 = _t788
                    _t789 = Proto.Instruction(OneOf(:upsert, upsert226))
                    _t787 = _t789
                else
                    ...
                    if prediction224 == 0
                        ...
                        assign225 = _t791
                        _t792 = Proto.Instruction(OneOf(:assign, assign225))
                        _t790 = _t792
                    else
...
function parse_assign(parser::Parser)::Proto.Assign
    ...
    attrs232 = _t795
    consume_literal!(parser, ")")
    _t797 = Proto.Assign(relation_id230, abstraction231, (!isnothing(attrs232) ? attrs232 : Proto.Attribute[]))
    return _t797
end
...
function parse_upsert(parser::Parser)::Proto.Upsert
    ...
    attrs235 = _t800
    consume_literal!(parser, ")")
    _t802 = Proto.Upsert(relation_id233, abstraction_with_arity234[1], (!isnothing(attrs235) ? attrs235 : Proto.Attribute[]), abstraction_with_arity234[2])
    return _t802
end
...
function parse_abstraction_with_arity(parser::Parser)::Tuple{Proto.Abstraction, Int64}
    ...
    formula237 = _t804
    consume_literal!(parser, ")")
    _t805 = Proto.Abstraction(vcat(bindings236[1], !isnothing(bindings236[2]) ? bindings236[2] : []), formula237)
...
function parse_break(parser::Parser)::Proto.Break
    ...
    attrs240 = _t808
    consume_literal!(parser, ")")
    _t810 = Proto.Break(relation_id238, abstraction239, (!isnothing(attrs240) ? attrs240 : Proto.Attribute[]))
    return _t810
end
...
function parse_monoid_def(parser::Parser)::Proto.MonoidDef
    ...
    attrs244 = _t814
    consume_literal!(parser, ")")
    _t816 = Proto.MonoidDef(monoid241, relation_id242, abstraction_with_arity243[1], (!isnothing(attrs244) ? attrs244 : Proto.Attribute[]), abstraction_with_arity243[2])
    return _t816
end
...
function parse_monoid(parser::Parser)::Proto.Monoid
    ...
    if prediction245 == 3
        ...
        sum_monoid249 = _t823
        _t824 = Proto.Monoid(OneOf(:sum_monoid, sum_monoid249))
        _t822 = _t824
    else
        ...
        if prediction245 == 2
            ...
            max_monoid248 = _t826
            _t827 = Proto.Monoid(OneOf(:max_monoid, max_monoid248))
            _t825 = _t827
        else
            ...
            if prediction245 == 1
                ...
                min_monoid247 = _t829
                _t830 = Proto.Monoid(OneOf(:min_monoid, min_monoid247))
                _t828 = _t830
            else
                ...
                if prediction245 == 0
                    ...
                    or_monoid246 = _t832
                    _t833 = Proto.Monoid(OneOf(:or_monoid, or_monoid246))
                    _t831 = _t833
                else
...
function parse_monus_def(parser::Parser)::Proto.MonusDef
    ...
    attrs256 = _t844
    consume_literal!(parser, ")")
    _t846 = Proto.MonusDef(monoid253, relation_id254, abstraction_with_arity255[1], (!isnothing(attrs256) ? attrs256 : Proto.Attribute[]), abstraction_with_arity255[2])
    return _t846
end
...
function parse_data(parser::Parser)::Proto.Data
    ...
    if prediction269 == 2
        ...
        csv_data272 = _t860
        _t861 = Proto.Data(OneOf(:csv_data, csv_data272))
        _t859 = _t861
    else
        ...
        if prediction269 == 1
            ...
            _t864 = Proto.Data(OneOf(:betree_relation, betree_relation271))
            _t862 = _t864
        else
            ...
            if prediction269 == 0
                ...
                rel_edb270 = _t866
                _t867 = Proto.Data(OneOf(:rel_edb, rel_edb270))
                _t865 = _t867
            else
...
function parse_rel_edb(parser::Parser)::Proto.RelEDB
    ...
    consume_literal!(parser, ")")
    _t871 = Proto.RelEDB(relation_id273, rel_edb_path274, rel_edb_types275)
    return _t871
end
...
function parse_betree_relation(parser::Parser)::Proto.BeTreeRelation
    ...
    consume_literal!(parser, ")")
    _t875 = Proto.BeTreeRelation(relation_id284, betree_info285)
    return _t875
end
...
function parse_csv_data(parser::Parser)::Proto.CSVData
    ...
    csv_asof300 = _t885
    consume_literal!(parser, ")")
    _t886 = Proto.CSVData(csvlocator297, csv_config298, csv_columns299, csv_asof300)
    return _t886
end
...
function parse_csvlocator(parser::Parser)::Proto.CSVLocator
    ...
    consume_literal!(parser, ")")
    _t891 = Proto.CSVLocator((!isnothing(csv_locator_paths301) ? csv_locator_paths301 : String[]), Vector{UInt8}((!isnothing(csv_locator_inline_data302) ? csv_locator_inline_data302 : "")))
    return _t891
end
...
function parse_csv_column(parser::Parser)::Proto.CSVColumn
    ...
    consume_literal!(parser, "]")
    consume_literal!(parser, ")")
    _t897 = Proto.CSVColumn(string313, relation_id314, types318)
    return _t897
end
...
function parse_undefine(parser::Parser)::Proto.Undefine
    ...
    consume_literal!(parser, ")")
    _t899 = Proto.Undefine(fragment_id320)
    return _t899
end
...
function parse_context(parser::Parser)::Proto.Context
    ...
    consume_literal!(parser, ")")
    _t901 = Proto.Context(relation_ids324)
    return _t901
end
...
function parse_read(parser::Parser)::Proto.Read
    ...
    if prediction329 == 4
        ...
        export334 = _t910
        _t911 = Proto.Read(OneOf(:var"#export", export334))
        _t909 = _t911
    else
        ...
        if prediction329 == 3
            ...
            abort333 = _t913
            _t914 = Proto.Read(OneOf(:abort, abort333))
            _t912 = _t914
        else
            ...
            if prediction329 == 2
                ...
                what_if332 = _t916
                _t917 = Proto.Read(OneOf(:what_if, what_if332))
                _t915 = _t917
            else
                ...
                if prediction329 == 1
                    ...
                    output331 = _t919
                    _t920 = Proto.Read(OneOf(:output, output331))
                    _t918 = _t920
                else
                    ...
                    if prediction329 == 0
                        ...
                        demand330 = _t922
                        _t923 = Proto.Read(OneOf(:demand, demand330))
                        _t921 = _t923
                    else
...
function parse_demand(parser::Parser)::Proto.Demand
    ...
    consume_literal!(parser, ")")
    _t925 = Proto.Demand(relation_id335)
    return _t925
end
...
function parse_output(parser::Parser)::Proto.Output
    ...
    if (match_lookahead_literal(parser, ":", 0) && match_lookahead_terminal(parser, "SYMBOL", 1))
        _t927 = parse_name(parser)
        _t926 = _t927
    else
        _t926 = nothing
    end
    name336 = _t926
    _t928 = parse_relation_id(parser)
    relation_id337 = _t928
    consume_literal!(parser, ")")
    _t929 = Proto.Output((!isnothing(name336) ? name336 : "output"), relation_id337)
    return _t929
end
...
function parse_what_if(parser::Parser)::Proto.WhatIf
    ...
    _t930 = parse_name(parser)
    name338 = _t930
    _t931 = parse_epoch(parser)
    epoch339 = _t931
    consume_literal!(parser, ")")
    _t932 = Proto.WhatIf(name338, epoch339)
    return _t932
end
...
function parse_abort(parser::Parser)::Proto.Abort
    ...
    if (match_lookahead_literal(parser, ":", 0) && match_lookahead_terminal(parser, "SYMBOL", 1))
        _t934 = parse_name(parser)
        _t933 = _t934
    else
        _t933 = nothing
    end
    name340 = _t933
    _t935 = parse_relation_id(parser)
    relation_id341 = _t935
    consume_literal!(parser, ")")
    _t936 = Proto.Abort((!isnothing(name340) ? name340 : "abort"), relation_id341)
    return _t936
end
...
function parse_export(parser::Parser)::Proto.Export
    ...
    _t937 = parse_export_csv_config(parser)
    export_csv_config342 = _t937
    consume_literal!(parser, ")")
    _t938 = Proto.Export(OneOf(:csv_config, export_csv_config342))
    return _t938
end
...
function parse_export_csv_config(parser::Parser)::Proto.ExportCSVConfig
    ...
    _t939 = parse_export_csv_path(parser)
    export_csv_path343 = _t939
    _t940 = parse_export_csv_columns(parser)
    export_csv_columns344 = _t940
    _t941 = parse_config_dict(parser)
    config_dict345 = _t941
    consume_literal!(parser, ")")
    _t942 = export_csv_config(parser, export_csv_path343, export_csv_columns344, config_dict345)
    return _t942
end
...
function parse_export_csv_columns(parser::Parser)::Vector{Proto.ExportCSVColumn}
    ...
    while cond348
        _t943 = parse_export_csv_column(parser)
        item349 = _t943
        push!(xs347, item349)
        cond348 = match_lookahead_literal(parser, "(", 0)
    end
...
function parse_export_csv_column(parser::Parser)::Proto.ExportCSVColumn
    ...
    consume_literal!(parser, ")")
    _t945 = Proto.ExportCSVColumn(string351, relation_id352)
    return _t945
end
