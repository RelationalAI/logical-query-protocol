# Autogenerated using ProtoBuf.jl v1.2.0 on 2026-01-15T19:26:08.818
# original file: /Users/nystrom/rai/nn-meta-4-parser-gen/proto/relationalai/lqp/v1/logic.proto (proto3 syntax)
...
PB.default_values(::Type{Constraint}) = (;functional_dependency = nothing, name = nothing)
PB.field_numbers(::Type{Constraint}) = (;functional_dependency = 1, name = 2)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Constraint})
    ...
    while !PB.message_done(d)
        ...
        elseif field_number == 2
            name = PB.decode(d, Ref{RelationId})
        else
            Base.skip(d, wire_type)
        end
    end
    return Constraint(constraint_type, name)
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::Constraint)
    ...
    !isnothing(x.name) && PB.encode(e, 2, x.name::RelationId)
    return position(e.io) - initpos
end
function PB._encoded_size(x::Constraint)
    ...
    !isnothing(x.name) && (encoded_size += PB._encoded_size(x.name::RelationId, 2))
    return encoded_size
end
