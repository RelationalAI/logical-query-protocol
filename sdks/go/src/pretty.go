...
func (p *PrettyPrinter) deconstruct_configure(msg *pb.Configure) [][]interface{} {
	...
	if msg.GetIvmConfig().GetLevel() == pb.MaintenanceLevel_MAINTENANCE_LEVEL_AUTO {
		_t1757 := p._make_value_string("auto")
		result = append(result, []interface{}{"ivm.maintenance_level", _t1757})
	} else {
		if msg.GetIvmConfig().GetLevel() == pb.MaintenanceLevel_MAINTENANCE_LEVEL_ALL {
			_t1758 := p._make_value_string("all")
			result = append(result, []interface{}{"ivm.maintenance_level", _t1758})
		} else {
			if msg.GetIvmConfig().GetLevel() == pb.MaintenanceLevel_MAINTENANCE_LEVEL_OFF {
				_t1759 := p._make_value_string("off")
				result = append(result, []interface{}{"ivm.maintenance_level", _t1759})
			}
		}
	}
	_t1760 := p._make_value_int64(msg.GetSemanticsVersion())
	result = append(result, []interface{}{"semantics_version", _t1760})
	return listSort(result)
}

func (p *PrettyPrinter) deconstruct_csv_config(msg *pb.CSVConfig) [][]interface{} {
	result := [][]interface{}{}
	_t1761 := p._make_value_int32(msg.GetHeaderRow())
	result = append(result, []interface{}{"csv_header_row", _t1761})
	_t1762 := p._make_value_int64(msg.GetSkip())
	result = append(result, []interface{}{"csv_skip", _t1762})
	if msg.GetNewLine() != "" {
		_t1763 := p._make_value_string(msg.GetNewLine())
		result = append(result, []interface{}{"csv_new_line", _t1763})
	}
	_t1764 := p._make_value_string(msg.GetDelimiter())
	result = append(result, []interface{}{"csv_delimiter", _t1764})
	_t1765 := p._make_value_string(msg.GetQuotechar())
	result = append(result, []interface{}{"csv_quotechar", _t1765})
	_t1766 := p._make_value_string(msg.GetEscapechar())
	result = append(result, []interface{}{"csv_escapechar", _t1766})
	if msg.GetComment() != "" {
		_t1767 := p._make_value_string(msg.GetComment())
		result = append(result, []interface{}{"csv_comment", _t1767})
	}
	for _, missing_string := range msg.GetMissingStrings() {
		_t1768 := p._make_value_string(missing_string)
		result = append(result, []interface{}{"csv_missing_strings", _t1768})
	}
	_t1769 := p._make_value_string(msg.GetDecimalSeparator())
	result = append(result, []interface{}{"csv_decimal_separator", _t1769})
	_t1770 := p._make_value_string(msg.GetEncoding())
	result = append(result, []interface{}{"csv_encoding", _t1770})
	_t1771 := p._make_value_string(msg.GetCompression())
	result = append(result, []interface{}{"csv_compression", _t1771})
	if msg.GetPartitionSizeMb() != 0 {
		_t1772 := p._make_value_int64(msg.GetPartitionSizeMb())
		result = append(result, []interface{}{"csv_partition_size_mb", _t1772})
	}
	return listSort(result)
}
...
func (p *PrettyPrinter) deconstruct_betree_info_config(msg *pb.BeTreeInfo) [][]interface{} {
	result := [][]interface{}{}
	_t1773 := p._make_value_float64(msg.GetStorageConfig().GetEpsilon())
	result = append(result, []interface{}{"betree_config_epsilon", _t1773})
	_t1774 := p._make_value_int64(msg.GetStorageConfig().GetMaxPivots())
	result = append(result, []interface{}{"betree_config_max_pivots", _t1774})
	_t1775 := p._make_value_int64(msg.GetStorageConfig().GetMaxDeltas())
	result = append(result, []interface{}{"betree_config_max_deltas", _t1775})
	_t1776 := p._make_value_int64(msg.GetStorageConfig().GetMaxLeaf())
	result = append(result, []interface{}{"betree_config_max_leaf", _t1776})
	if hasProtoField(msg.GetRelationLocator(), "root_pageid") {
		if msg.GetRelationLocator().GetRootPageid() != nil {
			_t1777 := p._make_value_uint128(msg.GetRelationLocator().GetRootPageid())
			result = append(result, []interface{}{"betree_locator_root_pageid", _t1777})
		}
	}
	if hasProtoField(msg.GetRelationLocator(), "inline_data") {
		if msg.GetRelationLocator().GetInlineData() != nil {
			_t1778 := p._make_value_string(string(msg.GetRelationLocator().GetInlineData()))
			result = append(result, []interface{}{"betree_locator_inline_data", _t1778})
		}
	}
	_t1779 := p._make_value_int64(msg.GetRelationLocator().GetElementCount())
	result = append(result, []interface{}{"betree_locator_element_count", _t1779})
	_t1780 := p._make_value_int64(msg.GetRelationLocator().GetTreeHeight())
	result = append(result, []interface{}{"betree_locator_tree_height", _t1780})
	return listSort(result)
}
...
func (p *PrettyPrinter) deconstruct_export_csv_config(msg *pb.ExportCSVConfig) [][]interface{} {
	...
	if msg.PartitionSize != nil {
		_t1781 := p._make_value_int64(*msg.PartitionSize)
		result = append(result, []interface{}{"partition_size", _t1781})
	}
	if msg.Compression != nil {
		_t1782 := p._make_value_string(*msg.Compression)
		result = append(result, []interface{}{"compression", _t1782})
	}
	if msg.SyntaxHeaderRow != nil {
		_t1783 := p._make_value_boolean(*msg.SyntaxHeaderRow)
		result = append(result, []interface{}{"syntax_header_row", _t1783})
	}
	if msg.SyntaxMissingString != nil {
		_t1784 := p._make_value_string(*msg.SyntaxMissingString)
		result = append(result, []interface{}{"syntax_missing_string", _t1784})
	}
	if msg.SyntaxDelim != nil {
		_t1785 := p._make_value_string(*msg.SyntaxDelim)
		result = append(result, []interface{}{"syntax_delim", _t1785})
	}
	if msg.SyntaxQuotechar != nil {
		_t1786 := p._make_value_string(*msg.SyntaxQuotechar)
		result = append(result, []interface{}{"syntax_quotechar", _t1786})
	}
	if msg.SyntaxEscapechar != nil {
		_t1787 := p._make_value_string(*msg.SyntaxEscapechar)
		result = append(result, []interface{}{"syntax_escapechar", _t1787})
	}
	return listSort(result)
}
...
func (p *PrettyPrinter) deconstruct_export_iceberg_config_optional(msg *pb.ExportIcebergConfig) [][]interface{} {
	result := [][]interface{}{}
	if *msg.Prefix != "" {
		_t1791 := p._make_value_string(*msg.Prefix)
		result = append(result, []interface{}{"prefix", _t1791})
	}
	if *msg.TargetFileSizeBytes != 0 {
		_t1792 := p._make_value_int64(*msg.TargetFileSizeBytes)
		result = append(result, []interface{}{"target_file_size_bytes", _t1792})
	}
	if msg.GetCompression() != "" {
		_t1793 := p._make_value_string(msg.GetCompression())
		result = append(result, []interface{}{"compression", _t1793})
	}
...
func (p *PrettyPrinter) pretty_iceberg_data(msg *pb.IcebergData) interface{} {
	...
	if flat1446 != nil {
		...
		_dollar_dollar := msg
		_t1733 := p.deconstruct_iceberg_data_from_snapshot_optional(_dollar_dollar)
		_t1734 := p.deconstruct_iceberg_data_to_snapshot_optional(_dollar_dollar)
		fields1436 := []interface{}{_dollar_dollar.GetLocator(), _dollar_dollar.GetConfig(), _dollar_dollar.GetColumns(), _t1733, _t1734, _dollar_dollar.GetReturnsDelta()}
...
func (p *PrettyPrinter) pretty_iceberg_catalog_config(msg *pb.IcebergCatalogConfig) interface{} {
	...
	if flat1468 != nil {
		...
		_dollar_dollar := msg
		_t1735 := p.deconstruct_iceberg_catalog_config_scope_optional(_dollar_dollar)
		fields1461 := []interface{}{_dollar_dollar.GetCatalogUri(), _t1735, dictToPairs(_dollar_dollar.GetProperties()), dictToPairs(_dollar_dollar.GetAuthProperties())}
...
func (p *PrettyPrinter) pretty_iceberg_masked_property_entry(msg []interface{}) interface{} {
	...
	if flat1490 != nil {
		...
		_dollar_dollar := msg
		_t1736 := p.mask_secret_value(_dollar_dollar)
		fields1486 := []interface{}{_dollar_dollar[0].(string), _t1736}
...
func (p *PrettyPrinter) pretty_read(msg *pb.Read) interface{} {
	...
	if flat1529 != nil {
		...
		_dollar_dollar := msg
		var _t1737 *pb.Demand
		if hasProtoField(_dollar_dollar, "demand") {
			_t1737 = _dollar_dollar.GetDemand()
		}
		...
		if deconstruct_result1527 != nil {
			...
			_dollar_dollar := msg
			var _t1738 *pb.Output
			if hasProtoField(_dollar_dollar, "output") {
				_t1738 = _dollar_dollar.GetOutput()
			}
			...
			if deconstruct_result1525 != nil {
				...
				_dollar_dollar := msg
				var _t1739 *pb.WhatIf
				if hasProtoField(_dollar_dollar, "what_if") {
					_t1739 = _dollar_dollar.GetWhatIf()
				}
				...
				if deconstruct_result1523 != nil {
					...
					if hasProtoField(_dollar_dollar, "abort") {
						_t1740 = _dollar_dollar.GetAbort()
					}
					...
					if deconstruct_result1521 != nil {
						...
						_dollar_dollar := msg
						var _t1741 *pb.Export
						if hasProtoField(_dollar_dollar, "export") {
							_t1741 = _dollar_dollar.GetExport()
						}
...
func (p *PrettyPrinter) pretty_abort(msg *pb.Abort) interface{} {
	...
	if flat1548 != nil {
		...
		if _dollar_dollar.GetName() != "abort" {
			_t1742 = ptr(_dollar_dollar.GetName())
		}
		fields1543 := []interface{}{_t1742, _dollar_dollar.GetRelationId()}
...
func (p *PrettyPrinter) pretty_export(msg *pb.Export) interface{} {
	...
	if flat1553 != nil {
		...
		_dollar_dollar := msg
		var _t1743 *pb.ExportCSVConfig
		if hasProtoField(_dollar_dollar, "csv_config") {
			_t1743 = _dollar_dollar.GetCsvConfig()
		}
		...
		if deconstruct_result1551 != nil {
			...
			_dollar_dollar := msg
			var _t1744 *pb.ExportIcebergConfig
			if hasProtoField(_dollar_dollar, "iceberg_config") {
				_t1744 = _dollar_dollar.GetIcebergConfig()
			}
...
func (p *PrettyPrinter) pretty_export_csv_config(msg *pb.ExportCSVConfig) interface{} {
	...
	if flat1564 != nil {
		...
		if int64(len(_dollar_dollar.GetDataColumns())) == 0 {
			_t1745 = []interface{}{_dollar_dollar.GetPath(), _dollar_dollar.GetCsvSource(), _dollar_dollar.GetCsvConfig()}
		}
		...
		if deconstruct_result1559 != nil {
			...
			if int64(len(_dollar_dollar.GetDataColumns())) != 0 {
				_t1747 := p.deconstruct_export_csv_config(_dollar_dollar)
				_t1746 = []interface{}{_dollar_dollar.GetPath(), _dollar_dollar.GetDataColumns(), _t1747}
			}
...
func (p *PrettyPrinter) pretty_export_csv_source(msg *pb.ExportCSVSource) interface{} {
	...
	if flat1573 != nil {
		...
		if hasProtoField(_dollar_dollar, "gnf_columns") {
			_t1748 = _dollar_dollar.GetGnfColumns().GetColumns()
		}
		...
		if deconstruct_result1569 != nil {
			...
			_dollar_dollar := msg
			var _t1749 *pb.RelationId
			if hasProtoField(_dollar_dollar, "table_def") {
				_t1749 = _dollar_dollar.GetTableDef()
			}
...
func (p *PrettyPrinter) pretty_export_iceberg_config(msg *pb.ExportIcebergConfig) interface{} {
	flat1592 := p.tryFlat(msg, func() { p.pretty_export_iceberg_config(msg) })
	if flat1592 != nil {
		p.write(*flat1592)
		return nil
	} else {
		_dollar_dollar := msg
		_t1750 := p.deconstruct_export_iceberg_config_optional(_dollar_dollar)
		fields1583 := []interface{}{_dollar_dollar.GetLocator(), _dollar_dollar.GetConfig(), _dollar_dollar.GetTableDef(), _dollar_dollar.GetColumns(), dictToPairs(_dollar_dollar.GetTableProperties()), _t1750}
		...
		p.newline()
		field1588 := unwrapped_fields1584[3].([]*pb.ExportColumn)
		p.pretty_export_iceberg_columns(field1588)
		p.newline()
		field1589 := unwrapped_fields1584[4].([][]interface{})
		p.pretty_iceberg_table_properties(field1589)
		field1590 := unwrapped_fields1584[5].([][]interface{})
		if field1590 != nil {
			p.newline()
			opt_val1591 := field1590
			p.pretty_config_dict(opt_val1591)
		}
		p.dedent()
		p.write(")")
	}
...
func (p *PrettyPrinter) pretty_export_iceberg_table_def(msg *pb.RelationId) interface{} {
	flat1594 := p.tryFlat(msg, func() { p.pretty_export_iceberg_table_def(msg) })
	if flat1594 != nil {
		p.write(*flat1594)
		return nil
	} else {
		...
		p.indentSexp()
		p.newline()
		p.pretty_relation_id(fields1593)
		p.dedent()
		p.write(")")
	}
	return nil
...
func (p *PrettyPrinter) pretty_export_iceberg_columns(msg []*pb.ExportColumn) interface{} {
	flat1598 := p.tryFlat(msg, func() { p.pretty_export_iceberg_columns(msg) })
	if flat1598 != nil {
		p.write(*flat1598)
		return nil
	} else {
		...
		if !(len(fields1595) == 0) {
			...
			for i1597, elem1596 := range fields1595 {
				...
				p.pretty_export_iceberg_column(elem1596)
			}
		}
		p.dedent()
		p.write(")")
...
func (p *PrettyPrinter) pretty_export_iceberg_column(msg *pb.ExportColumn) interface{} {
	flat1603 := p.tryFlat(msg, func() { p.pretty_export_iceberg_column(msg) })
	if flat1603 != nil {
		p.write(*flat1603)
		return nil
	} else {
		_dollar_dollar := msg
		fields1599 := []interface{}{_dollar_dollar.GetName(), _dollar_dollar.GetNullable()}
		unwrapped_fields1600 := fields1599
		p.write("(")
		p.write("column")
		p.indentSexp()
		p.newline()
		field1601 := unwrapped_fields1600[0].(string)
		p.write(p.formatStringValue(field1601))
		p.newline()
		field1602 := unwrapped_fields1600[1].(bool)
		p.pretty_boolean_value(field1602)
		p.dedent()
		p.write(")")
	}
	return nil
...
func (p *PrettyPrinter) pretty_debug_info(msg *pb.DebugInfo) interface{} {
	...
	for _idx, _rid := range msg.GetIds() {
		p.newline()
		p.write("(")
		_t1796 := &pb.UInt128Value{Low: _rid.GetIdLow(), High: _rid.GetIdHigh()}
		p.pprintDispatch(_t1796)
		p.write(" ")
