...
class Parser:
    ...
    def _extract_value_int32(self, value: Optional[logic_pb2.Value], default: int) -> int:
        ...
        if value is not None:
            ...
            _t955 = value.HasField('int_value')
        else:
            _t955 = False
        if _t955:
            assert value is not None
    ...
    def _extract_value_int64(self, value: Optional[logic_pb2.Value], default: int) -> int:
        ...
        if value is not None:
            assert value is not None
            _t956 = value.HasField('int_value')
        else:
            _t956 = False
        if _t956:
            assert value is not None
    ...
    def _extract_value_float64(self, value: Optional[logic_pb2.Value], default: float) -> float:
        ...
        if value is not None:
            assert value is not None
            _t957 = value.HasField('float_value')
        else:
            _t957 = False
        if _t957:
            assert value is not None
    ...
    def _extract_value_boolean(self, value: Optional[logic_pb2.Value], default: bool) -> bool:
        ...
        if value is not None:
            assert value is not None
            _t959 = value.HasField('boolean_value')
        else:
            _t959 = False
        if _t959:
            assert value is not None
    ...
    def _extract_value_bytes(self, value: Optional[logic_pb2.Value], default: bytes) -> bytes:
        ...
        if value is not None:
            assert value is not None
            _t960 = value.HasField('string_value')
        else:
            _t960 = False
        if _t960:
            assert value is not None
    ...
    def _extract_value_uint128(self, value: Optional[logic_pb2.Value], default: logic_pb2.UInt128Value) -> logic_pb2.UInt128Value:
        ...
        if value is not None:
            assert value is not None
            _t961 = value.HasField('uint128_value')
        else:
            _t961 = False
        if _t961:
            assert value is not None
    ...
    def _try_extract_value_int64(self, value: Optional[logic_pb2.Value]) -> Optional[int]:
        ...
        if value is not None:
            assert value is not None
            _t963 = value.HasField('int_value')
        else:
            _t963 = False
        if _t963:
            assert value is not None
    ...
    def _try_extract_value_float64(self, value: Optional[logic_pb2.Value]) -> Optional[float]:
        ...
        if value is not None:
            assert value is not None
            _t964 = value.HasField('float_value')
        else:
            _t964 = False
        if _t964:
            assert value is not None
    ...
    def _try_extract_value_string(self, value: Optional[logic_pb2.Value]) -> Optional[str]:
        ...
        if value is not None:
            assert value is not None
            _t965 = value.HasField('string_value')
        else:
            _t965 = False
        if _t965:
            assert value is not None
    ...
    def _try_extract_value_bytes(self, value: Optional[logic_pb2.Value]) -> Optional[bytes]:
        ...
        if value is not None:
            assert value is not None
            _t966 = value.HasField('string_value')
        else:
            _t966 = False
        if _t966:
            assert value is not None
    ...
    def _try_extract_value_uint128(self, value: Optional[logic_pb2.Value]) -> Optional[logic_pb2.UInt128Value]:
        ...
        if value is not None:
            assert value is not None
            _t967 = value.HasField('uint128_value')
        else:
            _t967 = False
        if _t967:
            assert value is not None
    ...
    def construct_csv_config(self, config_dict: Sequence[tuple[str, logic_pb2.Value]]) -> logic_pb2.CSVConfig:
        ...
        _t969 = self._extract_value_int32(config.get('csv_header_row'), 1)
        header_row = _t969
        _t970 = self._extract_value_int64(config.get('csv_skip'), 0)
        skip = _t970
        _t971 = self._extract_value_string(config.get('csv_new_line'), '')
        new_line = _t971
        _t972 = self._extract_value_string(config.get('csv_delimiter'), ',')
        delimiter = _t972
        _t973 = self._extract_value_string(config.get('csv_quotechar'), '"')
        quotechar = _t973
        _t974 = self._extract_value_string(config.get('csv_escapechar'), '"')
        escapechar = _t974
        _t975 = self._extract_value_string(config.get('csv_comment'), '')
        comment = _t975
        _t976 = self._extract_value_string_list(config.get('csv_missing_strings'), [])
        missing_strings = _t976
        _t977 = self._extract_value_string(config.get('csv_decimal_separator'), '.')
        decimal_separator = _t977
        _t978 = self._extract_value_string(config.get('csv_encoding'), 'utf-8')
        encoding = _t978
        _t979 = self._extract_value_string(config.get('csv_compression'), 'auto')
        compression = _t979
        _t980 = logic_pb2.CSVConfig(header_row=header_row, skip=skip, new_line=new_line, delimiter=delimiter, quotechar=quotechar, escapechar=escapechar, comment=comment, missing_strings=missing_strings, decimal_separator=decimal_separator, encoding=encoding, compression=compression)
        return _t980
    ...
    def construct_betree_info(self, key_types: Sequence[logic_pb2.Type], value_types: Sequence[logic_pb2.Type], config_dict: Sequence[tuple[str, logic_pb2.Value]]) -> logic_pb2.BeTreeInfo:
        config = dict(config_dict)
        _t981 = self._try_extract_value_float64(config.get('betree_config_epsilon'))
        epsilon = _t981
        _t982 = self._try_extract_value_int64(config.get('betree_config_max_pivots'))
        max_pivots = _t982
        _t983 = self._try_extract_value_int64(config.get('betree_config_max_deltas'))
        max_deltas = _t983
        _t984 = self._try_extract_value_int64(config.get('betree_config_max_leaf'))
        max_leaf = _t984
        _t985 = logic_pb2.BeTreeConfig(epsilon=epsilon, max_pivots=max_pivots, max_deltas=max_deltas, max_leaf=max_leaf)
        storage_config = _t985
        _t986 = self._try_extract_value_uint128(config.get('betree_locator_root_pageid'))
        root_pageid = _t986
        _t987 = self._try_extract_value_bytes(config.get('betree_locator_inline_data'))
        inline_data = _t987
        _t988 = self._try_extract_value_int64(config.get('betree_locator_element_count'))
        element_count = _t988
        _t989 = self._try_extract_value_int64(config.get('betree_locator_tree_height'))
        tree_height = _t989
        _t990 = logic_pb2.BeTreeLocator(root_pageid=root_pageid, inline_data=inline_data, element_count=element_count, tree_height=tree_height)
        relation_locator = _t990
        _t991 = logic_pb2.BeTreeInfo(key_types=key_types, value_types=value_types, storage_config=storage_config, relation_locator=relation_locator)
        return _t991
            ...
            if maintenance_level_val.string_value == 'off':
                ...
                if maintenance_level_val.string_value == 'auto':
                    ...
                    if maintenance_level_val.string_value == 'all':
                        ...
                        maintenance_level = transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_OFF
        _t994 = transactions_pb2.IVMConfig(level=maintenance_level)
        ivm_config = _t994
        _t995 = self._extract_value_int64(config.get('semantics_version'), 0)
        semantics_version = _t995
        _t996 = transactions_pb2.Configure(semantics_version=semantics_version, ivm_config=ivm_config)
        return _t996
    ...
    def export_csv_config(self, path: str, columns: Sequence[transactions_pb2.ExportCSVColumn], config_dict: Sequence[tuple[str, logic_pb2.Value]]) -> transactions_pb2.ExportCSVConfig:
        ...
        _t998 = self._extract_value_string(config.get('compression'), '')
        compression = _t998
        _t999 = self._extract_value_boolean(config.get('syntax_header_row'), True)
        syntax_header_row = _t999
        _t1000 = self._extract_value_string(config.get('syntax_missing_string'), '')
        syntax_missing_string = _t1000
        _t1001 = self._extract_value_string(config.get('syntax_delim'), ',')
        syntax_delim = _t1001
        _t1002 = self._extract_value_string(config.get('syntax_quotechar'), '"')
        syntax_quotechar = _t1002
        _t1003 = self._extract_value_string(config.get('syntax_escapechar'), '\\')
        syntax_escapechar = _t1003
        _t1004 = transactions_pb2.ExportCSVConfig(path=path, data_columns=columns, partition_size=partition_size, compression=compression, syntax_header_row=syntax_header_row, syntax_missing_string=syntax_missing_string, syntax_delim=syntax_delim, syntax_quotechar=syntax_quotechar, syntax_escapechar=syntax_escapechar)
        return _t1004

    def _make_value_int32(self, v: int) -> logic_pb2.Value:
        _t1005 = logic_pb2.Value(int_value=int(v))
        return _t1005

    def _make_value_int64(self, v: int) -> logic_pb2.Value:
        _t1006 = logic_pb2.Value(int_value=v)
        return _t1006

    def _make_value_float64(self, v: float) -> logic_pb2.Value:
        _t1007 = logic_pb2.Value(float_value=v)
        return _t1007

    def _make_value_string(self, v: str) -> logic_pb2.Value:
        _t1008 = logic_pb2.Value(string_value=v)
        return _t1008

    def _make_value_boolean(self, v: bool) -> logic_pb2.Value:
        _t1009 = logic_pb2.Value(boolean_value=v)
        return _t1009

    def _make_value_uint128(self, v: logic_pb2.UInt128Value) -> logic_pb2.Value:
        _t1010 = logic_pb2.Value(uint128_value=v)
        return _t1010
    ...
    def deconstruct_configure(self, msg: transactions_pb2.Configure) -> list[tuple[str, logic_pb2.Value]]:
        ...
        if msg.ivm_config.level == transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_AUTO:
            _t1011 = self._make_value_string('auto')
            result.append(('ivm.maintenance_level', _t1011,))
        else:
            if msg.ivm_config.level == transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_ALL:
                _t1012 = self._make_value_string('all')
                result.append(('ivm.maintenance_level', _t1012,))
            else:
                if msg.ivm_config.level == transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_OFF:
                    _t1013 = self._make_value_string('off')
                    result.append(('ivm.maintenance_level', _t1013,))
        _t1014 = self._make_value_int64(msg.semantics_version)
        result.append(('semantics_version', _t1014,))
        return sorted(result)

    def deconstruct_csv_config(self, msg: logic_pb2.CSVConfig) -> list[tuple[str, logic_pb2.Value]]:
        result = []
        _t1015 = self._make_value_int32(msg.header_row)
        result.append(('csv_header_row', _t1015,))
        _t1016 = self._make_value_int64(msg.skip)
        result.append(('csv_skip', _t1016,))
        if msg.new_line != '':
            _t1017 = self._make_value_string(msg.new_line)
            result.append(('csv_new_line', _t1017,))
        _t1018 = self._make_value_string(msg.delimiter)
        result.append(('csv_delimiter', _t1018,))
        _t1019 = self._make_value_string(msg.quotechar)
        result.append(('csv_quotechar', _t1019,))
        _t1020 = self._make_value_string(msg.escapechar)
        result.append(('csv_escapechar', _t1020,))
        if msg.comment != '':
            _t1021 = self._make_value_string(msg.comment)
            result.append(('csv_comment', _t1021,))
        for missing_string in msg.missing_strings:
            _t1022 = self._make_value_string(missing_string)
            result.append(('csv_missing_strings', _t1022,))
        _t1023 = self._make_value_string(msg.decimal_separator)
        result.append(('csv_decimal_separator', _t1023,))
        _t1024 = self._make_value_string(msg.encoding)
        result.append(('csv_encoding', _t1024,))
        _t1025 = self._make_value_string(msg.compression)
        result.append(('csv_compression', _t1025,))
        return sorted(result)

    def deconstruct_betree_info_config(self, msg: logic_pb2.BeTreeInfo) -> list[tuple[str, logic_pb2.Value]]:
        result = []
        _t1026 = self._make_value_float64(msg.storage_config.epsilon)
        result.append(('betree_config_epsilon', _t1026,))
        _t1027 = self._make_value_int64(msg.storage_config.max_pivots)
        result.append(('betree_config_max_pivots', _t1027,))
        _t1028 = self._make_value_int64(msg.storage_config.max_deltas)
        result.append(('betree_config_max_deltas', _t1028,))
        _t1029 = self._make_value_int64(msg.storage_config.max_leaf)
        result.append(('betree_config_max_leaf', _t1029,))
        if msg.relation_locator.HasField('root_pageid'):
            if msg.relation_locator.root_pageid is not None:
                ...
                _t1030 = self._make_value_uint128(msg.relation_locator.root_pageid)
                result.append(('betree_locator_root_pageid', _t1030,))
        if msg.relation_locator.HasField('inline_data'):
            if msg.relation_locator.inline_data is not None:
                ...
                _t1031 = self._make_value_string(msg.relation_locator.inline_data.decode('utf-8'))
                result.append(('betree_locator_inline_data', _t1031,))
        _t1032 = self._make_value_int64(msg.relation_locator.element_count)
        result.append(('betree_locator_element_count', _t1032,))
        _t1033 = self._make_value_int64(msg.relation_locator.tree_height)
        result.append(('betree_locator_tree_height', _t1033,))
        return sorted(result)
    ...
    def deconstruct_export_csv_config(self, msg: transactions_pb2.ExportCSVConfig) -> list[tuple[str, logic_pb2.Value]]:
        ...
        if msg.compression is not None:
            ...
            _t1035 = self._make_value_string(msg.compression)
            result.append(('compression', _t1035,))
        if msg.syntax_header_row is not None:
            assert msg.syntax_header_row is not None
            _t1036 = self._make_value_boolean(msg.syntax_header_row)
            result.append(('syntax_header_row', _t1036,))
        if msg.syntax_missing_string is not None:
            assert msg.syntax_missing_string is not None
            _t1037 = self._make_value_string(msg.syntax_missing_string)
            result.append(('syntax_missing_string', _t1037,))
        if msg.syntax_delim is not None:
            assert msg.syntax_delim is not None
            _t1038 = self._make_value_string(msg.syntax_delim)
            result.append(('syntax_delim', _t1038,))
        if msg.syntax_quotechar is not None:
            assert msg.syntax_quotechar is not None
            _t1039 = self._make_value_string(msg.syntax_quotechar)
            result.append(('syntax_quotechar', _t1039,))
        if msg.syntax_escapechar is not None:
            assert msg.syntax_escapechar is not None
            _t1040 = self._make_value_string(msg.syntax_escapechar)
            result.append(('syntax_escapechar', _t1040,))
        return sorted(result)
