...
class IcebergData(_message.Message):
    ...
    to_snapshot: str
    returns_delta: bool
    def __init__(self, locator: _Optional[_Union[IcebergLocator, _Mapping]] = ..., config: _Optional[_Union[IcebergCatalogConfig, _Mapping]] = ..., columns: _Optional[_Iterable[_Union[GNFColumn, _Mapping]]] = ..., from_snapshot: _Optional[str] = ..., to_snapshot: _Optional[str] = ..., returns_delta: bool = ...) -> None: ...
