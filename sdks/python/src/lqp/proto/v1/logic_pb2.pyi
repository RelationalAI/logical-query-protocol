...
class CSVTarget(_message.Message):
    __slots__ = ("target_id", "column_names", "types")
    TARGET_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    types: _containers.RepeatedCompositeFieldContainer[Type]
    def __init__(self, target_id: _Optional[_Union[RelationId, _Mapping]] = ..., column_names: _Optional[_Iterable[str]] = ..., types: _Optional[_Iterable[_Union[Type, _Mapping]]] = ...) -> None: ...

class CSVData(_message.Message):
    __slots__ = ("locator", "config", "columns", "asof", "target")
    ...
    asof: str
    target: CSVTarget
    def __init__(self, locator: _Optional[_Union[CSVLocator, _Mapping]] = ..., config: _Optional[_Union[CSVConfig, _Mapping]] = ..., columns: _Optional[_Iterable[_Union[GNFColumn, _Mapping]]] = ..., asof: _Optional[str] = ..., target: _Optional[_Union[CSVTarget, _Mapping]] = ...) -> None: ...
...
class IcebergCatalogConfig(_message.Message):
    ...
    AUTH_PROPERTIES_FIELD_NUMBER: _ClassVar[int]
    catalog_uri: str
    scope: str
    properties: _containers.ScalarMap[str, str]
    auth_properties: _containers.ScalarMap[str, str]
...
class Float32Type(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...
