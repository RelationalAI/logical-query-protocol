# Autogenerated using ProtoBuf.jl v1.2.0 on 2026-02-24T19:44:15.762
...
CSVColumn(;column_path = Vector{String}(), target_id = nothing, types = Vector{var"#Type"}()) = CSVColumn(column_path, target_id, types)
PB.default_values(::Type{CSVColumn}) = (;column_path = Vector{String}(), target_id = nothing, types = Vector{var"#Type"}())
PB.field_numbers(::Type{CSVColumn}) = (;column_path = 1, target_id = 2, types = 3)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CSVColumn})
    ...
    return CSVColumn(column_path[], target_id[], types[])
end
