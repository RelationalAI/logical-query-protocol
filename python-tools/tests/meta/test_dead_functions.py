...
from meta.target import (
    Assign, BaseType, Call, Foreach, ForeachEnumerated, FunDef,
    FunctionType, GetElement, GetField, IfElse, Lambda, Let, ListExpr,
    Lit, MessageType, NamedFun, NewMessage, Return, Seq, Var, While,
)
