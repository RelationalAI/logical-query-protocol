...
from .codegen_templates import PYTHON_TEMPLATES, PYTHON_PRETTY_TEMPLATES
...
def generate_pretty_printer_python(grammar: Grammar, command_line: Optional[str] = None,
    ...
    # Register pretty-printing templates (on top of the default parser templates)
    codegen.register_builtins_from_templates(PYTHON_PRETTY_TEMPLATES)
