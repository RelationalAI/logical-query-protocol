...
(def construct_betree_info
  ...
  (let (config (Dict String (Message logic Value)))
       ...
       (root_pageid (Message logic UInt128Value))
        (call (named-fun _extract_value_uint128) (dict-lookup (var config (Dict String (Message logic Value))) (lit "betree_locator_root_pageid")) (call (builtin none)))
       (inline_data Bytes)
        (call (named-fun _extract_value_bytes) (dict-lookup (var config (Dict String (Message logic Value))) (lit "betree_locator_inline_data")) (call (builtin none)))
       (element_count Int64)
       ...
       (relation_locator (Message logic BeTreeLocator))
        (new-message logic BeTreeLocator
          (root_pageid (var root_pageid (Message logic UInt128Value)))
          (inline_data (var inline_data Bytes))
