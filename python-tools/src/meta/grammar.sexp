...
(def construct_csv_config
  ...
  (let (config (Dict String (Message logic Value)))
       ...
       (header_row Int64)
        (call (builtin _extract_value_int64) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_header_row")) (lit 1))
       (skip Int64)
        (call (builtin _extract_value_int64) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_skip")) (lit 0))
       (new_line String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_new_line")) (lit ""))
       (delimiter String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_delimiter")) (lit ","))
       (quotechar String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_quotechar")) (lit "\""))
       (escapechar String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_escapechar")) (lit "\""))
       (comment String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_comment")) (lit ""))
       (missing_strings (List String))
        (call (builtin _extract_value_string_list) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_missing_strings")) (list String))
       (decimal_separator String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_decimal_separator")) (lit "."))
       (encoding String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_encoding")) (lit "utf-8"))
       (compression String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "csv_compression")) (lit "auto"))
...
(def construct_betree_info
  ...
  (let (config (Dict String (Message logic Value)))
        (dict-from-list (var config_dict (List (Tuple String (Message logic Value)))) String (Message logic Value))
       (epsilon Float64)
        (call (builtin _extract_value_float64) (dict-lookup (var config (Dict String (Message logic Value))) (lit "betree_config_epsilon")) (lit 0.5))
       (max_pivots Int64)
        (call (builtin _extract_value_int64) (dict-lookup (var config (Dict String (Message logic Value))) (lit "betree_config_max_pivots")) (lit 4))
       (max_deltas Int64)
        (call (builtin _extract_value_int64) (dict-lookup (var config (Dict String (Message logic Value))) (lit "betree_config_max_deltas")) (lit 16))
       (max_leaf Int64)
        (call (builtin _extract_value_int64) (dict-lookup (var config (Dict String (Message logic Value))) (lit "betree_config_max_leaf")) (lit 16))
       ...
       (root_pageid (Message logic UInt128Value))
        (call (builtin _extract_value_uint128) (dict-lookup (var config (Dict String (Message logic Value))) (lit "betree_locator_root_pageid")) (call (builtin none)))
       (inline_data Bytes)
        (call (builtin _extract_value_bytes) (dict-lookup (var config (Dict String (Message logic Value))) (lit "betree_locator_inline_data")) (call (builtin none)))
       (element_count Int64)
        (call (builtin _extract_value_int64) (dict-lookup (var config (Dict String (Message logic Value))) (lit "betree_locator_element_count")) (lit 0))
       (tree_height Int64)
        (call (builtin _extract_value_int64) (dict-lookup (var config (Dict String (Message logic Value))) (lit "betree_locator_tree_height")) (lit 0))
...
(def construct_configure
  ...
  (let (config (Dict String (Message logic Value)))
       ...
       (semantics_version Int64)
        (call (builtin _extract_value_int64)
              (dict-lookup
                (var config (Dict String (Message logic Value)))
...
(def export_csv_config
  ...
  (let (config (Dict String (Message logic Value)))
       ...
       (partition_size Int64)
        (call (builtin _extract_value_int64) (dict-lookup (var config (Dict String (Message logic Value))) (lit "partition_size")) (lit 0))
       (compression String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "compression")) (lit ""))
       (syntax_header_row Boolean)
        (call (builtin _extract_value_boolean) (dict-lookup (var config (Dict String (Message logic Value))) (lit "syntax_header_row")) (lit true))
       (syntax_missing_string String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "syntax_missing_string")) (lit ""))
       (syntax_delim String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "syntax_delim")) (lit ","))
       (syntax_quotechar String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "syntax_quotechar")) (lit "\""))
       (syntax_escapechar String)
        (call (builtin _extract_value_string) (dict-lookup (var config (Dict String (Message logic Value))) (lit "syntax_escapechar")) (lit "\\"))
