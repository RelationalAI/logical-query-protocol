...
class Parser:
    ...
    def parse_relation_id(self) -> logic_pb2.RelationId:
        ...
        if prediction55 == 1:
            ...
            if prediction55 == 0:
                symbol56 = self.consume_terminal('COLON_SYMBOL')
    ...
    def parse_name(self) -> str:
        symbol120 = self.consume_terminal('COLON_SYMBOL')
        return symbol120
    ...
    def parse_algorithm(self) -> logic_pb2.Algorithm:
        ...
        xs185 = []
        cond186 = (self.match_lookahead_terminal('COLON_SYMBOL', 0) or self.match_lookahead_terminal('INT', 0))
        while cond186:
        ...
        body188 = _t4760
        self.consume_literal(')')
        _t4761 = logic_pb2.Algorithm(**{'global': global187}, body=body188)
        return _t4761
    ...
    def parse_context(self) -> transactions_pb2.Context:
        ...
        xs239 = []
        cond240 = (self.match_lookahead_terminal('COLON_SYMBOL', 0) or self.match_lookahead_terminal('INT', 0))
        while cond240:
