...
class RelValueTypeValue(_message.Message):
    __slots__ = ("date", "datetime")
    DATE_FIELD_NUMBER: _ClassVar[int]
    DATETIME_FIELD_NUMBER: _ClassVar[int]
    date: Date
    datetime: DateTime
    def __init__(self, date: _Optional[_Union[Date, _Mapping]] = ..., datetime: _Optional[_Union[DateTime, _Mapping]] = ...) -> None: ...
...
class DateTime(_message.Message):
    ...
    utc_offset: int
    time_zone: TimeZone
    def __init__(self, year: _Optional[int] = ..., month: _Optional[int] = ..., day: _Optional[int] = ..., hours: _Optional[int] = ..., minutes: _Optional[int] = ..., seconds: _Optional[int] = ..., nanos: _Optional[int] = ..., utc_offset: _Optional[int] = ..., time_zone: _Optional[_Union[TimeZone, _Mapping]] = ...) -> None: ...
