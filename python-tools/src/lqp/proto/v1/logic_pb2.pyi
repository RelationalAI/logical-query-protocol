...
class Loop(_message.Message):
    __slots__ = ("temporal_var", "inits", "body")
    TEMPORAL_VAR_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, temporal_var: _Optional[str] = ..., inits: _Optional[_Iterable[_Union[Def, _Mapping]]] = ..., body: _Optional[_Iterable[_Union[Declaration, _Mapping]]] = ...) -> None: ...
