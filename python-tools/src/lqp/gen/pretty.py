...
class PrettyPrinter:
    ...
    def _extract_value_int32(self, value: Optional[logic_pb2.Value], default: int) -> int:
        ...
        if value is not None:
            ...
            _t1290 = value.HasField('int_value')
        else:
            _t1290 = False
        if _t1290:
            assert value is not None
    ...
    def _extract_value_int64(self, value: Optional[logic_pb2.Value], default: int) -> int:
        ...
        if value is not None:
            assert value is not None
            _t1291 = value.HasField('int_value')
        else:
            _t1291 = False
        if _t1291:
            assert value is not None
    ...
    def _extract_value_float64(self, value: Optional[logic_pb2.Value], default: float) -> float:
        ...
        if value is not None:
            assert value is not None
            _t1292 = value.HasField('float_value')
        else:
            _t1292 = False
        if _t1292:
            assert value is not None
    ...
    def _extract_value_string(self, value: Optional[logic_pb2.Value], default: str) -> str:
        ...
        if value is not None:
            assert value is not None
            _t1293 = value.HasField('string_value')
        else:
            _t1293 = False
        if _t1293:
            assert value is not None
    ...
    def _extract_value_boolean(self, value: Optional[logic_pb2.Value], default: bool) -> bool:
        ...
        if value is not None:
            assert value is not None
            _t1294 = value.HasField('boolean_value')
        else:
            _t1294 = False
        if _t1294:
            assert value is not None
    ...
    def _extract_value_bytes(self, value: Optional[logic_pb2.Value], default: bytes) -> bytes:
        ...
        if value is not None:
            assert value is not None
            _t1295 = value.HasField('string_value')
        else:
            _t1295 = False
        if _t1295:
            assert value is not None
    ...
    def _extract_value_uint128(self, value: Optional[logic_pb2.Value], default: logic_pb2.UInt128Value) -> logic_pb2.UInt128Value:
        ...
        if value is not None:
            assert value is not None
            _t1296 = value.HasField('uint128_value')
        else:
            _t1296 = False
        if _t1296:
            assert value is not None
    ...
    def _extract_value_string_list(self, value: Optional[logic_pb2.Value], default: list[str]) -> list[str]:
        ...
        if value is not None:
            assert value is not None
            _t1297 = value.HasField('string_value')
        else:
            _t1297 = False
        if _t1297:
            assert value is not None
    ...
    def _try_extract_value_float64(self, value: Optional[logic_pb2.Value]) -> Optional[float]:
        ...
        if value is not None:
            assert value is not None
            _t1299 = value.HasField('float_value')
        else:
            _t1299 = False
        if _t1299:
            assert value is not None
    ...
    def _try_extract_value_string(self, value: Optional[logic_pb2.Value]) -> Optional[str]:
        ...
        if value is not None:
            assert value is not None
            _t1300 = value.HasField('string_value')
        else:
            _t1300 = False
        if _t1300:
            assert value is not None
    ...
    def _try_extract_value_bytes(self, value: Optional[logic_pb2.Value]) -> Optional[bytes]:
        ...
        if value is not None:
            assert value is not None
            _t1301 = value.HasField('string_value')
        else:
            _t1301 = False
        if _t1301:
            assert value is not None
    ...
    def _try_extract_value_uint128(self, value: Optional[logic_pb2.Value]) -> Optional[logic_pb2.UInt128Value]:
        ...
        if value is not None:
            assert value is not None
            _t1302 = value.HasField('uint128_value')
        else:
            _t1302 = False
        if _t1302:
            assert value is not None
    ...
    def _try_extract_value_string_list(self, value: Optional[logic_pb2.Value]) -> Optional[list[str]]:
        ...
        if value is not None:
            assert value is not None
            _t1303 = value.HasField('string_value')
        else:
            _t1303 = False
        if _t1303:
            assert value is not None
    ...
    def construct_csv_config(self, config_dict: list[tuple[str, logic_pb2.Value]]) -> logic_pb2.CSVConfig:
        ...
        header_row = _t1304
        _t1305 = self._extract_value_int64(config.get('csv_skip'), 0)
        skip = _t1305
        _t1306 = self._extract_value_string(config.get('csv_new_line'), '')
        new_line = _t1306
        _t1307 = self._extract_value_string(config.get('csv_delimiter'), ',')
        delimiter = _t1307
        _t1308 = self._extract_value_string(config.get('csv_quotechar'), '"')
        quotechar = _t1308
        _t1309 = self._extract_value_string(config.get('csv_escapechar'), '"')
        escapechar = _t1309
        _t1310 = self._extract_value_string(config.get('csv_comment'), '')
        comment = _t1310
        _t1311 = self._extract_value_string_list(config.get('csv_missing_strings'), [])
        missing_strings = _t1311
        _t1312 = self._extract_value_string(config.get('csv_decimal_separator'), '.')
        decimal_separator = _t1312
        _t1313 = self._extract_value_string(config.get('csv_encoding'), 'utf-8')
        encoding = _t1313
        _t1314 = self._extract_value_string(config.get('csv_compression'), 'auto')
        compression = _t1314
    ...
    def construct_betree_info(self, key_types: list[logic_pb2.Type], value_types: list[logic_pb2.Type], config_dict: list[tuple[str, logic_pb2.Value]]) -> logic_pb2.BeTreeInfo:
        ...
        epsilon = _t1316
        _t1317 = self._try_extract_value_int64(config.get('betree_config_max_pivots'))
        max_pivots = _t1317
        _t1318 = self._try_extract_value_int64(config.get('betree_config_max_deltas'))
        max_deltas = _t1318
        _t1319 = self._try_extract_value_int64(config.get('betree_config_max_leaf'))
        max_leaf = _t1319
        _t1320 = logic_pb2.BeTreeConfig(epsilon=epsilon, max_pivots=max_pivots, max_deltas=max_deltas, max_leaf=max_leaf)
        storage_config = _t1320
        _t1321 = self._try_extract_value_uint128(config.get('betree_locator_root_pageid'))
        root_pageid = _t1321
        _t1322 = self._try_extract_value_bytes(config.get('betree_locator_inline_data'))
        inline_data = _t1322
        _t1323 = self._try_extract_value_int64(config.get('betree_locator_element_count'))
        element_count = _t1323
        _t1324 = self._try_extract_value_int64(config.get('betree_locator_tree_height'))
        tree_height = _t1324
        _t1325 = logic_pb2.BeTreeLocator(root_pageid=root_pageid, inline_data=inline_data, element_count=element_count, tree_height=tree_height)
        relation_locator = _t1325
        _t1326 = logic_pb2.BeTreeInfo(key_types=key_types, value_types=value_types, storage_config=storage_config, relation_locator=relation_locator)
        return _t1326

    def default_configure(self) -> transactions_pb2.Configure:
        _t1327 = transactions_pb2.IVMConfig(level=transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_OFF)
        ivm_config = _t1327
            ...
            if maintenance_level_val.string_value == 'off':
                ...
                if maintenance_level_val.string_value == 'auto':
                    ...
                    if maintenance_level_val.string_value == 'all':
                        ...
                        maintenance_level = transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_OFF
        _t1329 = transactions_pb2.IVMConfig(level=maintenance_level)
        ivm_config = _t1329
        _t1330 = self._extract_value_int64(config.get('semantics_version'), 0)
        semantics_version = _t1330
    ...
    def export_csv_config(self, path: str, columns: list[transactions_pb2.ExportCSVColumn], config_dict: list[tuple[str, logic_pb2.Value]]) -> transactions_pb2.ExportCSVConfig:
        ...
        _t1333 = self._extract_value_string(config.get('compression'), '')
        compression = _t1333
        _t1334 = self._extract_value_boolean(config.get('syntax_header_row'), True)
        syntax_header_row = _t1334
        _t1335 = self._extract_value_string(config.get('syntax_missing_string'), '')
        syntax_missing_string = _t1335
        _t1336 = self._extract_value_string(config.get('syntax_delim'), ',')
        syntax_delim = _t1336
        _t1337 = self._extract_value_string(config.get('syntax_quotechar'), '"')
        syntax_quotechar = _t1337
        _t1338 = self._extract_value_string(config.get('syntax_escapechar'), '\\')
        syntax_escapechar = _t1338
        _t1339 = transactions_pb2.ExportCSVConfig(path=path, data_columns=columns, partition_size=partition_size, compression=compression, syntax_header_row=syntax_header_row, syntax_missing_string=syntax_missing_string, syntax_delim=syntax_delim, syntax_quotechar=syntax_quotechar, syntax_escapechar=syntax_escapechar)
        return _t1339

    def _make_value_int32(self, v: int) -> logic_pb2.Value:
        _t1340 = logic_pb2.Value(int_value=int(v))
        return _t1340

    def _make_value_int64(self, v: int) -> logic_pb2.Value:
        _t1341 = logic_pb2.Value(int_value=v)
        return _t1341

    def _make_value_float64(self, v: float) -> logic_pb2.Value:
        _t1342 = logic_pb2.Value(float_value=v)
        return _t1342

    def _make_value_string(self, v: str) -> logic_pb2.Value:
        _t1343 = logic_pb2.Value(string_value=v)
        return _t1343

    def _make_value_boolean(self, v: bool) -> logic_pb2.Value:
        _t1344 = logic_pb2.Value(boolean_value=v)
        return _t1344

    def _make_value_uint128(self, v: logic_pb2.UInt128Value) -> logic_pb2.Value:
        _t1345 = logic_pb2.Value(uint128_value=v)
        return _t1345
    ...
    def deconstruct_configure(self, msg: transactions_pb2.Configure) -> list[tuple[str, logic_pb2.Value]]:
        ...
        if msg.ivm_config.level == transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_AUTO:
            _t1347 = self._make_value_string('auto')
            result.append(('ivm.maintenance_level', _t1347,))
            _t1346 = None
        else:
            
            if msg.ivm_config.level == transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_ALL:
                _t1349 = self._make_value_string('all')
                result.append(('ivm.maintenance_level', _t1349,))
                _t1348 = None
            else:
                
                if msg.ivm_config.level == transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_OFF:
                    _t1351 = self._make_value_string('off')
                    result.append(('ivm.maintenance_level', _t1351,))
                    _t1350 = None
                else:
                    _t1350 = None
                _t1348 = _t1350
            _t1346 = _t1348
        _t1352 = self._make_value_int64(msg.semantics_version)
        result.append(('semantics_version', _t1352,))
        return sorted(result)

    def deconstruct_csv_config(self, msg: logic_pb2.CSVConfig) -> list[tuple[str, logic_pb2.Value]]:
        result = []
        _t1353 = self._make_value_int32(msg.header_row)
        result.append(('csv_header_row', _t1353,))
        _t1354 = self._make_value_int64(msg.skip)
        result.append(('csv_skip', _t1354,))
        _t1355 = self._make_value_string(msg.new_line)
        result.append(('csv_new_line', _t1355,))
        _t1356 = self._make_value_string(msg.delimiter)
        result.append(('csv_delimiter', _t1356,))
        _t1357 = self._make_value_string(msg.quotechar)
        result.append(('csv_quotechar', _t1357,))
        _t1358 = self._make_value_string(msg.escapechar)
        result.append(('csv_escapechar', _t1358,))
        _t1359 = self._make_value_string(msg.comment)
        result.append(('csv_comment', _t1359,))
        for missing_string in msg.missing_strings:
            _t1360 = self._make_value_string(missing_string)
            result.append(('csv_missing_strings', _t1360,))
        _t1361 = self._make_value_string(msg.decimal_separator)
        result.append(('csv_decimal_separator', _t1361,))
        _t1362 = self._make_value_string(msg.encoding)
        result.append(('csv_encoding', _t1362,))
        _t1363 = self._make_value_string(msg.compression)
        result.append(('csv_compression', _t1363,))
        return sorted(result)
    ...
    def _maybe_push_float64(self, result: list[tuple[str, logic_pb2.Value]], key: str, val: Optional[float]) -> None:
        ...
        if val is not None:
            ...
            _t1365 = self._make_value_float64(val)
    ...
    def _maybe_push_int64(self, result: list[tuple[str, logic_pb2.Value]], key: str, val: Optional[int]) -> None:
        ...
        if val is not None:
            assert val is not None
            _t1367 = self._make_value_int64(val)
    ...
    def _maybe_push_uint128(self, result: list[tuple[str, logic_pb2.Value]], key: str, val: Optional[logic_pb2.UInt128Value]) -> None:
        ...
        if val is not None:
            assert val is not None
            _t1369 = self._make_value_uint128(val)
            result.append((key, _t1369,))
            _t1368 = None
        else:
            _t1368 = None
        return None
    ...
    def _maybe_push_bytes_as_string(self, result: list[tuple[str, logic_pb2.Value]], key: str, val: Optional[bytes]) -> None:
        ...
        if val is not None:
            assert val is not None
            _t1371 = self._make_value_string(val.decode('utf-8'))
            result.append((key, _t1371,))
            _t1370 = None
        else:
            _t1370 = None
        return None
    ...
    def deconstruct_betree_info_config(self, msg: logic_pb2.BeTreeInfo) -> list[tuple[str, logic_pb2.Value]]:
        result = []
        _t1372 = self._maybe_push_float64(result, 'betree_config_epsilon', msg.storage_config.epsilon)
        _t1373 = self._maybe_push_int64(result, 'betree_config_max_pivots', msg.storage_config.max_pivots)
        _t1374 = self._maybe_push_int64(result, 'betree_config_max_deltas', msg.storage_config.max_deltas)
        _t1375 = self._maybe_push_int64(result, 'betree_config_max_leaf', msg.storage_config.max_leaf)
        
        if msg.relation_locator.HasField('root_pageid'):
            _t1377 = self._maybe_push_uint128(result, 'betree_locator_root_pageid', msg.relation_locator.root_pageid)
            _t1376 = _t1377
        else:
            _t1376 = None
        
        if msg.relation_locator.HasField('inline_data'):
            _t1379 = self._maybe_push_bytes_as_string(result, 'betree_locator_inline_data', msg.relation_locator.inline_data)
            _t1378 = _t1379
        else:
            _t1378 = None
        _t1380 = self._maybe_push_int64(result, 'betree_locator_element_count', msg.relation_locator.element_count)
        _t1381 = self._maybe_push_int64(result, 'betree_locator_tree_height', msg.relation_locator.tree_height)
        return sorted(result)
    ...
    def deconstruct_export_csv_config(self, msg: transactions_pb2.ExportCSVConfig) -> list[tuple[str, logic_pb2.Value]]:
        ...
        if msg.partition_size is not None:
            ...
            _t1383 = self._make_value_int64(msg.partition_size)
            result.append(('partition_size', _t1383,))
            _t1382 = None
        else:
            _t1382 = None
        ...
        if msg.compression is not None:
            ...
            _t1385 = self._make_value_string(msg.compression)
            result.append(('compression', _t1385,))
            _t1384 = None
        else:
            _t1384 = None
        ...
        if msg.syntax_header_row is not None:
            ...
            _t1387 = self._make_value_boolean(msg.syntax_header_row)
            result.append(('syntax_header_row', _t1387,))
            _t1386 = None
        else:
            _t1386 = None
        ...
        if msg.syntax_missing_string is not None:
            ...
            _t1389 = self._make_value_string(msg.syntax_missing_string)
            result.append(('syntax_missing_string', _t1389,))
            _t1388 = None
        else:
            _t1388 = None
        ...
        if msg.syntax_delim is not None:
            ...
            _t1391 = self._make_value_string(msg.syntax_delim)
            result.append(('syntax_delim', _t1391,))
            _t1390 = None
        else:
            _t1390 = None
        ...
        if msg.syntax_quotechar is not None:
            ...
            _t1393 = self._make_value_string(msg.syntax_quotechar)
            result.append(('syntax_quotechar', _t1393,))
            _t1392 = None
        else:
            _t1392 = None
        ...
        if msg.syntax_escapechar is not None:
            ...
            _t1395 = self._make_value_string(msg.syntax_escapechar)
            result.append(('syntax_escapechar', _t1395,))
            _t1394 = None
        else:
            _t1394 = None
        return sorted(result)
        ...
        if not len(field6) == 0:
            ...
            for i8, elem7 in enumerate(field6):
                ...
                if (i8 > 0):
                    ...
                    _t498 = None
                _t499 = self.pretty_epoch(elem7)
        self.dedent()
        self.write(')')
        return None

    def pretty_configure(self, msg: transactions_pb2.Configure) -> Optional[Never]:
        def _t500(_dollar_dollar):
            _t501 = self.deconstruct_configure(_dollar_dollar)
            return _t501
        _t502 = _t500(msg)
        fields9 = _t502
        ...
        self.indent()
        self.newline()
        _t503 = self.pretty_config_dict(unwrapped_fields10)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields12) == 0:
            ...
            for i14, elem13 in enumerate(unwrapped_fields12):
                ...
                if (i14 > 0):
                    ...
                    _t506 = None
                _t507 = self.pretty_config_key_value(elem13)
        self.write('}')
        return None
    ...
    def pretty_config_key_value(self, msg: tuple[str, logic_pb2.Value]) -> Optional[Never]:
        ...
        _t510 = self.pretty_value(field18)
        return _t510
    ...
    def pretty_value(self, msg: logic_pb2.Value) -> Optional[Never]:
        def _t511(_dollar_dollar):
            ...
            if _dollar_dollar.HasField('date_value'):
                _t512 = _dollar_dollar.date_value
            else:
                _t512 = None
            return _t512
        _t513 = _t511(msg)
        ...
        if deconstruct_result29 is not None:
            _t515 = self.pretty_date(deconstruct_result29)
            _t514 = _t515
        else:
            def _t516(_dollar_dollar):
                
                if _dollar_dollar.HasField('datetime_value'):
                    _t517 = _dollar_dollar.datetime_value
                else:
                    _t517 = None
                return _t517
            _t518 = _t516(msg)
            ...
            if deconstruct_result28 is not None:
                _t520 = self.pretty_datetime(deconstruct_result28)
                _t519 = _t520
            else:
                def _t521(_dollar_dollar):
                    
                    if _dollar_dollar.HasField('string_value'):
                        _t522 = _dollar_dollar.string_value
                    else:
                        _t522 = None
                    return _t522
                _t523 = _t521(msg)
                ...
                if deconstruct_result27 is not None:
                    ...
                    def _t525(_dollar_dollar):
                        
                        if _dollar_dollar.HasField('int_value'):
                            _t526 = _dollar_dollar.int_value
                        else:
                            _t526 = None
                        return _t526
                    _t527 = _t525(msg)
                    ...
                    if deconstruct_result26 is not None:
                        ...
                        def _t529(_dollar_dollar):
                            
                            if _dollar_dollar.HasField('float_value'):
                                _t530 = _dollar_dollar.float_value
                            else:
                                _t530 = None
                            return _t530
                        _t531 = _t529(msg)
                        ...
                        if deconstruct_result25 is not None:
                            ...
                            def _t533(_dollar_dollar):
                                
                                if _dollar_dollar.HasField('uint128_value'):
                                    _t534 = _dollar_dollar.uint128_value
                                else:
                                    _t534 = None
                                return _t534
                            _t535 = _t533(msg)
                            ...
                            if deconstruct_result24 is not None:
                                ...
                                def _t537(_dollar_dollar):
                                    
                                    if _dollar_dollar.HasField('int128_value'):
                                        _t538 = _dollar_dollar.int128_value
                                    else:
                                        _t538 = None
                                    return _t538
                                _t539 = _t537(msg)
                                ...
                                if deconstruct_result23 is not None:
                                    ...
                                    if deconstruct_result22 is not None:
                                        ...
                                        def _t545(_dollar_dollar):
                                            
                                            if _dollar_dollar.HasField('boolean_value'):
                                                _t546 = _dollar_dollar.boolean_value
                                            else:
                                                _t546 = None
                                            return _t546
                                        _t547 = _t545(msg)
                                        ...
                                        if deconstruct_result21 is not None:
                                            _t549 = self.pretty_boolean_value(deconstruct_result21)
                                            _t548 = _t549
                                        else:
        ...
        if not len(unwrapped_fields48) == 0:
            ...
            for i50, elem49 in enumerate(unwrapped_fields48):
                ...
                if (i50 > 0):
                    ...
                    _t567 = None
                _t568 = self.pretty_fragment_id(elem49)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_epoch(self, msg: transactions_pb2.Epoch) -> Optional[Never]:
        ...
        if field55 is not None:
            ...
            opt_val56 = field55
            _t576 = self.pretty_epoch_writes(opt_val56)
            _t575 = _t576
        else:
            _t575 = None
        ...
        if field57 is not None:
            ...
            opt_val58 = field57
            _t578 = self.pretty_epoch_reads(opt_val58)
            _t577 = _t578
        else:
            _t577 = None
        self.dedent()
        ...
        if not len(field71) == 0:
            ...
            for i73, elem72 in enumerate(field71):
                ...
                if (i73 > 0):
                    ...
                    _t605 = None
                _t606 = self.pretty_declaration(elem72)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_new_fragment_id(self, msg: fragments_pb2.FragmentId) -> Optional[Never]:
        ...
        _t609 = self.pretty_fragment_id(unwrapped_fields75)
        return _t609
    ...
    def pretty_declaration(self, msg: logic_pb2.Declaration) -> Optional[Never]:
        def _t610(_dollar_dollar):
            ...
            return _t611
        _t612 = _t610(msg)
        deconstruct_result79 = _t612
        
        if deconstruct_result79 is not None:
            _t614 = self.pretty_def(deconstruct_result79)
            _t613 = _t614
        else:
            def _t615(_dollar_dollar):
                ...
                return _t616
            _t617 = _t615(msg)
            deconstruct_result78 = _t617
            
            if deconstruct_result78 is not None:
                _t619 = self.pretty_algorithm(deconstruct_result78)
                _t618 = _t619
            else:
                def _t620(_dollar_dollar):
                    ...
                    return _t621
                _t622 = _t620(msg)
                deconstruct_result77 = _t622
                
                if deconstruct_result77 is not None:
                    _t624 = self.pretty_constraint(deconstruct_result77)
                    _t623 = _t624
                else:
                    def _t625(_dollar_dollar):
                        ...
                        return _t626
                    _t627 = _t625(msg)
                    deconstruct_result76 = _t627
                    
                    if deconstruct_result76 is not None:
                        _t629 = self.pretty_data(deconstruct_result76)
                        _t628 = _t629
                    else:
    ...
    def pretty_def(self, msg: logic_pb2.Def) -> Optional[Never]:
        ...
        _t633 = self.pretty_relation_id(field82)
        self.newline()
        field83 = unwrapped_fields81[1]
        _t634 = self.pretty_abstraction(field83)
        ...
        if field84 is not None:
            ...
            opt_val85 = field84
            _t636 = self.pretty_attrs(opt_val85)
            _t635 = _t636
        else:
            _t635 = None
        self.dedent()
    ...
    def pretty_abstraction(self, msg: logic_pb2.Abstraction) -> Optional[Never]:
        ...
        _t648 = self.pretty_bindings(field90)
        self.write(' ')
        field91 = unwrapped_fields89[1]
        _t649 = self.pretty_formula(field91)
        self.write(')')
        return None
    ...
    def pretty_bindings(self, msg: tuple[list[logic_pb2.Binding], list[logic_pb2.Binding]]) -> Optional[Never]:
        ...
        for i96, elem95 in enumerate(field94):
            ...
            if (i96 > 0):
                ...
                _t653 = None
            _t654 = self.pretty_binding(elem95)
        ...
        if field97 is not None:
            ...
            opt_val98 = field97
            _t656 = self.pretty_value_bindings(opt_val98)
            _t655 = _t656
        else:
            _t655 = None
        self.write(']')
    ...
    def pretty_binding(self, msg: logic_pb2.Binding) -> Optional[Never]:
        ...
        _t659 = self.pretty_type(field102)
        return _t659
    ...
    def pretty_type(self, msg: logic_pb2.Type) -> Optional[Never]:
        def _t660(_dollar_dollar):
            ...
            return _t661
        _t662 = _t660(msg)
        deconstruct_result113 = _t662
        
        if deconstruct_result113 is not None:
            _t664 = self.pretty_unspecified_type(deconstruct_result113)
            _t663 = _t664
        else:
            def _t665(_dollar_dollar):
                ...
                return _t666
            _t667 = _t665(msg)
            deconstruct_result112 = _t667
            
            if deconstruct_result112 is not None:
                _t669 = self.pretty_string_type(deconstruct_result112)
                _t668 = _t669
            else:
                def _t670(_dollar_dollar):
                    ...
                    return _t671
                _t672 = _t670(msg)
                deconstruct_result111 = _t672
                
                if deconstruct_result111 is not None:
                    _t674 = self.pretty_int_type(deconstruct_result111)
                    _t673 = _t674
                else:
                    def _t675(_dollar_dollar):
                        ...
                        return _t676
                    _t677 = _t675(msg)
                    deconstruct_result110 = _t677
                    
                    if deconstruct_result110 is not None:
                        _t679 = self.pretty_float_type(deconstruct_result110)
                        _t678 = _t679
                    else:
                        def _t680(_dollar_dollar):
                            ...
                            return _t681
                        _t682 = _t680(msg)
                        deconstruct_result109 = _t682
                        
                        if deconstruct_result109 is not None:
                            _t684 = self.pretty_uint128_type(deconstruct_result109)
                            _t683 = _t684
                        else:
                            def _t685(_dollar_dollar):
                                ...
                                return _t686
                            _t687 = _t685(msg)
                            deconstruct_result108 = _t687
                            
                            if deconstruct_result108 is not None:
                                _t689 = self.pretty_int128_type(deconstruct_result108)
                                _t688 = _t689
                            else:
                                def _t690(_dollar_dollar):
                                    ...
                                    return _t691
                                _t692 = _t690(msg)
                                deconstruct_result107 = _t692
                                
                                if deconstruct_result107 is not None:
                                    _t694 = self.pretty_date_type(deconstruct_result107)
                                    _t693 = _t694
                                else:
                                    def _t695(_dollar_dollar):
                                        ...
                                        return _t696
                                    _t697 = _t695(msg)
                                    deconstruct_result106 = _t697
                                    
                                    if deconstruct_result106 is not None:
                                        _t699 = self.pretty_datetime_type(deconstruct_result106)
                                        _t698 = _t699
                                    else:
                                        def _t700(_dollar_dollar):
                                            ...
                                            return _t701
                                        _t702 = _t700(msg)
                                        deconstruct_result105 = _t702
                                        
                                        if deconstruct_result105 is not None:
                                            _t704 = self.pretty_missing_type(deconstruct_result105)
                                            _t703 = _t704
                                        else:
                                            def _t705(_dollar_dollar):
                                                ...
                                                return _t706
                                            _t707 = _t705(msg)
                                            deconstruct_result104 = _t707
                                            
                                            if deconstruct_result104 is not None:
                                                _t709 = self.pretty_decimal_type(deconstruct_result104)
                                                _t708 = _t709
                                            else:
                                                def _t710(_dollar_dollar):
                                                    ...
                                                    return _t711
                                                _t712 = _t710(msg)
                                                deconstruct_result103 = _t712
                                                
                                                if deconstruct_result103 is not None:
                                                    _t714 = self.pretty_boolean_type(deconstruct_result103)
                                                    _t713 = _t714
                                                else:
        ...
        if not len(unwrapped_fields139) == 0:
            ...
            for i141, elem140 in enumerate(unwrapped_fields139):
                ...
                if (i141 > 0):
                    ...
                    _t739 = None
                _t740 = self.pretty_binding(elem140)
        return None
    ...
    def pretty_formula(self, msg: logic_pb2.Formula) -> Optional[Never]:
        def _t741(_dollar_dollar):
            ...
            return _t742
        _t743 = _t741(msg)
        deconstruct_result154 = _t743
        
        if deconstruct_result154 is not None:
            _t745 = self.pretty_true(deconstruct_result154)
            _t744 = _t745
        else:
            def _t746(_dollar_dollar):
                ...
                return _t747
            _t748 = _t746(msg)
            deconstruct_result153 = _t748
            
            if deconstruct_result153 is not None:
                _t750 = self.pretty_false(deconstruct_result153)
                _t749 = _t750
            else:
                def _t751(_dollar_dollar):
                    ...
                    return _t752
                _t753 = _t751(msg)
                deconstruct_result152 = _t753
                
                if deconstruct_result152 is not None:
                    _t755 = self.pretty_exists(deconstruct_result152)
                    _t754 = _t755
                else:
                    def _t756(_dollar_dollar):
                        ...
                        return _t757
                    _t758 = _t756(msg)
                    deconstruct_result151 = _t758
                    
                    if deconstruct_result151 is not None:
                        _t760 = self.pretty_reduce(deconstruct_result151)
                        _t759 = _t760
                    else:
                        def _t761(_dollar_dollar):
                            ...
                            return _t762
                        _t763 = _t761(msg)
                        deconstruct_result150 = _t763
                        
                        if deconstruct_result150 is not None:
                            _t765 = self.pretty_conjunction(deconstruct_result150)
                            _t764 = _t765
                        else:
                            def _t766(_dollar_dollar):
                                ...
                                return _t767
                            _t768 = _t766(msg)
                            deconstruct_result149 = _t768
                            
                            if deconstruct_result149 is not None:
                                _t770 = self.pretty_disjunction(deconstruct_result149)
                                _t769 = _t770
                            else:
                                def _t771(_dollar_dollar):
                                    ...
                                    return _t772
                                _t773 = _t771(msg)
                                deconstruct_result148 = _t773
                                
                                if deconstruct_result148 is not None:
                                    _t775 = self.pretty_not(deconstruct_result148)
                                    _t774 = _t775
                                else:
                                    def _t776(_dollar_dollar):
                                        ...
                                        return _t777
                                    _t778 = _t776(msg)
                                    deconstruct_result147 = _t778
                                    
                                    if deconstruct_result147 is not None:
                                        _t780 = self.pretty_ffi(deconstruct_result147)
                                        _t779 = _t780
                                    else:
                                        def _t781(_dollar_dollar):
                                            ...
                                            return _t782
                                        _t783 = _t781(msg)
                                        deconstruct_result146 = _t783
                                        
                                        if deconstruct_result146 is not None:
                                            _t785 = self.pretty_atom(deconstruct_result146)
                                            _t784 = _t785
                                        else:
                                            def _t786(_dollar_dollar):
                                                ...
                                                return _t787
                                            _t788 = _t786(msg)
                                            deconstruct_result145 = _t788
                                            
                                            if deconstruct_result145 is not None:
                                                _t790 = self.pretty_pragma(deconstruct_result145)
                                                _t789 = _t790
                                            else:
                                                def _t791(_dollar_dollar):
                                                    ...
                                                    return _t792
                                                _t793 = _t791(msg)
                                                deconstruct_result144 = _t793
                                                
                                                if deconstruct_result144 is not None:
                                                    _t795 = self.pretty_primitive(deconstruct_result144)
                                                    _t794 = _t795
                                                else:
                                                    def _t796(_dollar_dollar):
                                                        ...
                                                        return _t797
                                                    _t798 = _t796(msg)
                                                    deconstruct_result143 = _t798
                                                    
                                                    if deconstruct_result143 is not None:
                                                        _t800 = self.pretty_rel_atom(deconstruct_result143)
                                                        _t799 = _t800
                                                    else:
                                                        def _t801(_dollar_dollar):
                                                            ...
                                                            return _t802
                                                        _t803 = _t801(msg)
                                                        deconstruct_result142 = _t803
                                                        
                                                        if deconstruct_result142 is not None:
                                                            _t805 = self.pretty_cast(deconstruct_result142)
                                                            _t804 = _t805
                                                        else:
    ...
    def pretty_exists(self, msg: logic_pb2.Exists) -> Optional[Never]:
        ...
        _t813 = self.pretty_bindings(field161)
        self.newline()
        field162 = unwrapped_fields160[1]
        _t814 = self.pretty_formula(field162)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_reduce(self, msg: logic_pb2.Reduce) -> Optional[Never]:
        ...
        _t817 = self.pretty_abstraction(field165)
        self.newline()
        field166 = unwrapped_fields164[1]
        _t818 = self.pretty_abstraction(field166)
        self.newline()
        field167 = unwrapped_fields164[2]
        _t819 = self.pretty_terms(field167)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields169) == 0:
            ...
            for i171, elem170 in enumerate(unwrapped_fields169):
                ...
                if (i171 > 0):
                    ...
                    _t822 = None
                _t823 = self.pretty_term(elem170)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_term(self, msg: logic_pb2.Term) -> Optional[Never]:
        def _t824(_dollar_dollar):
            ...
            return _t825
        _t826 = _t824(msg)
        deconstruct_result173 = _t826
        
        if deconstruct_result173 is not None:
            _t828 = self.pretty_var(deconstruct_result173)
            _t827 = _t828
        else:
            def _t829(_dollar_dollar):
                ...
                return _t830
            _t831 = _t829(msg)
            deconstruct_result172 = _t831
            
            if deconstruct_result172 is not None:
                _t833 = self.pretty_constant(deconstruct_result172)
                _t832 = _t833
            else:
    ...
    def pretty_constant(self, msg: logic_pb2.Value) -> Optional[Never]:
        ...
        _t838 = self.pretty_value(unwrapped_fields177)
        return _t838
        ...
        if not len(unwrapped_fields179) == 0:
            ...
            for i181, elem180 in enumerate(unwrapped_fields179):
                ...
                if (i181 > 0):
                    ...
                    _t841 = None
                _t842 = self.pretty_formula(elem180)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields183) == 0:
            ...
            for i185, elem184 in enumerate(unwrapped_fields183):
                ...
                if (i185 > 0):
                    ...
                    _t845 = None
                _t846 = self.pretty_formula(elem184)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_not(self, msg: logic_pb2.Not) -> Optional[Never]:
        ...
        self.indent()
        self.newline()
        _t849 = self.pretty_formula(unwrapped_fields187)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_ffi(self, msg: logic_pb2.FFI) -> Optional[Never]:
        ...
        _t852 = self.pretty_name(field190)
        self.newline()
        field191 = unwrapped_fields189[1]
        _t853 = self.pretty_ffi_args(field191)
        self.newline()
        field192 = unwrapped_fields189[2]
        _t854 = self.pretty_terms(field192)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields196) == 0:
            ...
            for i198, elem197 in enumerate(unwrapped_fields196):
                ...
                if (i198 > 0):
                    ...
                    _t859 = None
                _t860 = self.pretty_abstraction(elem197)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_atom(self, msg: logic_pb2.Atom) -> Optional[Never]:
        ...
        _t863 = self.pretty_relation_id(field201)
        ...
        if not len(field202) == 0:
            ...
            for i204, elem203 in enumerate(field202):
                ...
                if (i204 > 0):
                    ...
                    _t864 = None
                _t865 = self.pretty_term(elem203)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_pragma(self, msg: logic_pb2.Pragma) -> Optional[Never]:
        ...
        _t868 = self.pretty_name(field207)
        ...
        if not len(field208) == 0:
            ...
            for i210, elem209 in enumerate(field208):
                ...
                if (i210 > 0):
                    ...
                    _t869 = None
                _t870 = self.pretty_term(elem209)
        self.dedent()
        self.write(')')
        return None
                                ...
                                if guard_result219 is not None:
                                    ...
                                    if guard_result218 is not None:
                                        ...
                                        if guard_result217 is not None:
                                            ...
                                            _t918 = self.pretty_name(field213)
                                            ...
                                            if not len(field214) == 0:
                                                ...
                                                for i216, elem215 in enumerate(field214):
                                                    ...
                                                    if (i216 > 0):
                                                        ...
                                                        _t919 = None
                                                    _t920 = self.pretty_rel_term(elem215)
                                            self.dedent()
                                            self.write(')')
                                            _t914 = None
                                        _t909 = _t914
    ...
    def pretty_eq(self, msg: logic_pb2.Primitive) -> Optional[Never]:
        ...
        _t924 = self.pretty_term(field228)
        self.newline()
        field229 = unwrapped_fields227[1]
        _t925 = self.pretty_term(field229)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_lt(self, msg: logic_pb2.Primitive) -> Optional[Never]:
        ...
        _t929 = self.pretty_term(field232)
        self.newline()
        field233 = unwrapped_fields231[1]
        _t930 = self.pretty_term(field233)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_lt_eq(self, msg: logic_pb2.Primitive) -> Optional[Never]:
        ...
        _t934 = self.pretty_term(field236)
        self.newline()
        field237 = unwrapped_fields235[1]
        _t935 = self.pretty_term(field237)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_gt(self, msg: logic_pb2.Primitive) -> Optional[Never]:
        ...
        _t939 = self.pretty_term(field240)
        self.newline()
        field241 = unwrapped_fields239[1]
        _t940 = self.pretty_term(field241)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_gt_eq(self, msg: logic_pb2.Primitive) -> Optional[Never]:
        ...
        _t944 = self.pretty_term(field244)
        self.newline()
        field245 = unwrapped_fields243[1]
        _t945 = self.pretty_term(field245)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_add(self, msg: logic_pb2.Primitive) -> Optional[Never]:
        ...
        _t949 = self.pretty_term(field248)
        self.newline()
        field249 = unwrapped_fields247[1]
        _t950 = self.pretty_term(field249)
        self.newline()
        field250 = unwrapped_fields247[2]
        _t951 = self.pretty_term(field250)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_minus(self, msg: logic_pb2.Primitive) -> Optional[Never]:
        ...
        _t955 = self.pretty_term(field253)
        self.newline()
        field254 = unwrapped_fields252[1]
        _t956 = self.pretty_term(field254)
        self.newline()
        field255 = unwrapped_fields252[2]
        _t957 = self.pretty_term(field255)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_multiply(self, msg: logic_pb2.Primitive) -> Optional[Never]:
        ...
        _t961 = self.pretty_term(field258)
        self.newline()
        field259 = unwrapped_fields257[1]
        _t962 = self.pretty_term(field259)
        self.newline()
        field260 = unwrapped_fields257[2]
        _t963 = self.pretty_term(field260)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_divide(self, msg: logic_pb2.Primitive) -> Optional[Never]:
        ...
        _t967 = self.pretty_term(field263)
        self.newline()
        field264 = unwrapped_fields262[1]
        _t968 = self.pretty_term(field264)
        self.newline()
        field265 = unwrapped_fields262[2]
        _t969 = self.pretty_term(field265)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_rel_term(self, msg: logic_pb2.RelTerm) -> Optional[Never]:
        def _t970(_dollar_dollar):
            ...
            return _t971
        _t972 = _t970(msg)
        deconstruct_result267 = _t972
        
        if deconstruct_result267 is not None:
            _t974 = self.pretty_specialized_value(deconstruct_result267)
            _t973 = _t974
        else:
            def _t975(_dollar_dollar):
                ...
                return _t976
            _t977 = _t975(msg)
            deconstruct_result266 = _t977
            
            if deconstruct_result266 is not None:
                _t979 = self.pretty_term(deconstruct_result266)
                _t978 = _t979
            else:
    ...
    def pretty_specialized_value(self, msg: logic_pb2.Value) -> Optional[Never]:
        ...
        self.write('#')
        _t982 = self.pretty_value(unwrapped_fields269)
        return _t982
    ...
    def pretty_rel_atom(self, msg: logic_pb2.RelAtom) -> Optional[Never]:
        ...
        _t985 = self.pretty_name(field272)
        ...
        if not len(field273) == 0:
            ...
            for i275, elem274 in enumerate(field273):
                ...
                if (i275 > 0):
                    ...
                    _t986 = None
                _t987 = self.pretty_rel_term(elem274)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_cast(self, msg: logic_pb2.Cast) -> Optional[Never]:
        ...
        _t990 = self.pretty_term(field278)
        self.newline()
        field279 = unwrapped_fields277[1]
        _t991 = self.pretty_term(field279)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields281) == 0:
            ...
            for i283, elem282 in enumerate(unwrapped_fields281):
                ...
                if (i283 > 0):
                    ...
                    _t994 = None
                _t995 = self.pretty_attribute(elem282)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_attribute(self, msg: logic_pb2.Attribute) -> Optional[Never]:
        ...
        _t998 = self.pretty_name(field286)
        ...
        if not len(field287) == 0:
            ...
            for i289, elem288 in enumerate(field287):
                ...
                if (i289 > 0):
                    ...
                    _t999 = None
                _t1000 = self.pretty_value(elem288)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(field292) == 0:
            ...
            for i294, elem293 in enumerate(field292):
                ...
                if (i294 > 0):
                    ...
                    _t1003 = None
                _t1004 = self.pretty_relation_id(elem293)
        self.newline()
        field295 = unwrapped_fields291[1]
        _t1005 = self.pretty_script(field295)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields297) == 0:
            ...
            for i299, elem298 in enumerate(unwrapped_fields297):
                ...
                if (i299 > 0):
                    ...
                    _t1008 = None
                _t1009 = self.pretty_construct(elem298)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_construct(self, msg: logic_pb2.Construct) -> Optional[Never]:
        def _t1010(_dollar_dollar):
            ...
            return _t1011
        _t1012 = _t1010(msg)
        deconstruct_result301 = _t1012
        
        if deconstruct_result301 is not None:
            _t1014 = self.pretty_loop(deconstruct_result301)
            _t1013 = _t1014
        else:
            def _t1015(_dollar_dollar):
                ...
                return _t1016
            _t1017 = _t1015(msg)
            deconstruct_result300 = _t1017
            
            if deconstruct_result300 is not None:
                _t1019 = self.pretty_instruction(deconstruct_result300)
                _t1018 = _t1019
            else:
    ...
    def pretty_loop(self, msg: logic_pb2.Loop) -> Optional[Never]:
        ...
        _t1022 = self.pretty_init(field304)
        self.newline()
        field305 = unwrapped_fields303[1]
        _t1023 = self.pretty_script(field305)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields307) == 0:
            ...
            for i309, elem308 in enumerate(unwrapped_fields307):
                ...
                if (i309 > 0):
                    ...
                    _t1026 = None
                _t1027 = self.pretty_instruction(elem308)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_instruction(self, msg: logic_pb2.Instruction) -> Optional[Never]:
        def _t1028(_dollar_dollar):
            ...
            return _t1029
        _t1030 = _t1028(msg)
        deconstruct_result314 = _t1030
        
        if deconstruct_result314 is not None:
            _t1032 = self.pretty_assign(deconstruct_result314)
            _t1031 = _t1032
        else:
            def _t1033(_dollar_dollar):
                ...
                return _t1034
            _t1035 = _t1033(msg)
            deconstruct_result313 = _t1035
            
            if deconstruct_result313 is not None:
                _t1037 = self.pretty_upsert(deconstruct_result313)
                _t1036 = _t1037
            else:
                def _t1038(_dollar_dollar):
                    ...
                    return _t1039
                _t1040 = _t1038(msg)
                deconstruct_result312 = _t1040
                
                if deconstruct_result312 is not None:
                    _t1042 = self.pretty_break(deconstruct_result312)
                    _t1041 = _t1042
                else:
                    def _t1043(_dollar_dollar):
                        ...
                        return _t1044
                    _t1045 = _t1043(msg)
                    deconstruct_result311 = _t1045
                    
                    if deconstruct_result311 is not None:
                        _t1047 = self.pretty_monoid_def(deconstruct_result311)
                        _t1046 = _t1047
                    else:
                        def _t1048(_dollar_dollar):
                            ...
                            return _t1049
                        _t1050 = _t1048(msg)
                        deconstruct_result310 = _t1050
                        
                        if deconstruct_result310 is not None:
                            _t1052 = self.pretty_monus_def(deconstruct_result310)
                            _t1051 = _t1052
                        else:
    ...
    def pretty_assign(self, msg: logic_pb2.Assign) -> Optional[Never]:
        ...
        _t1056 = self.pretty_relation_id(field317)
        self.newline()
        field318 = unwrapped_fields316[1]
        _t1057 = self.pretty_abstraction(field318)
        ...
        if field319 is not None:
            ...
            opt_val320 = field319
            _t1059 = self.pretty_attrs(opt_val320)
            _t1058 = _t1059
        else:
            _t1058 = None
        self.dedent()
    ...
    def pretty_upsert(self, msg: logic_pb2.Upsert) -> Optional[Never]:
        ...
        _t1063 = self.pretty_relation_id(field323)
        self.newline()
        field324 = unwrapped_fields322[1]
        _t1064 = self.pretty_abstraction_with_arity(field324)
        ...
        if field325 is not None:
            ...
            opt_val326 = field325
            _t1066 = self.pretty_attrs(opt_val326)
            _t1065 = _t1066
        else:
            _t1065 = None
        self.dedent()
    ...
    def pretty_abstraction_with_arity(self, msg: tuple[logic_pb2.Abstraction, int]) -> Optional[Never]:
        ...
        _t1070 = self.pretty_bindings(field329)
        self.write(' ')
        field330 = unwrapped_fields328[1]
        _t1071 = self.pretty_formula(field330)
        self.write(')')
        return None
    ...
    def pretty_break(self, msg: logic_pb2.Break) -> Optional[Never]:
        ...
        _t1075 = self.pretty_relation_id(field333)
        self.newline()
        field334 = unwrapped_fields332[1]
        _t1076 = self.pretty_abstraction(field334)
        ...
        if field335 is not None:
            ...
            opt_val336 = field335
            _t1078 = self.pretty_attrs(opt_val336)
            _t1077 = _t1078
        else:
            _t1077 = None
        self.dedent()
    ...
    def pretty_monoid_def(self, msg: logic_pb2.MonoidDef) -> Optional[Never]:
        ...
        _t1082 = self.pretty_monoid(field339)
        self.newline()
        field340 = unwrapped_fields338[1]
        _t1083 = self.pretty_relation_id(field340)
        self.newline()
        field341 = unwrapped_fields338[2]
        _t1084 = self.pretty_abstraction_with_arity(field341)
        ...
        if field342 is not None:
            ...
            opt_val343 = field342
            _t1086 = self.pretty_attrs(opt_val343)
            _t1085 = _t1086
        else:
            _t1085 = None
        self.dedent()
    ...
    def pretty_monoid(self, msg: logic_pb2.Monoid) -> Optional[Never]:
        def _t1087(_dollar_dollar):
            ...
            return _t1088
        _t1089 = _t1087(msg)
        deconstruct_result347 = _t1089
        
        if deconstruct_result347 is not None:
            _t1091 = self.pretty_or_monoid(deconstruct_result347)
            _t1090 = _t1091
        else:
            def _t1092(_dollar_dollar):
                ...
                return _t1093
            _t1094 = _t1092(msg)
            deconstruct_result346 = _t1094
            
            if deconstruct_result346 is not None:
                _t1096 = self.pretty_min_monoid(deconstruct_result346)
                _t1095 = _t1096
            else:
                def _t1097(_dollar_dollar):
                    ...
                    return _t1098
                _t1099 = _t1097(msg)
                deconstruct_result345 = _t1099
                
                if deconstruct_result345 is not None:
                    _t1101 = self.pretty_max_monoid(deconstruct_result345)
                    _t1100 = _t1101
                else:
                    def _t1102(_dollar_dollar):
                        ...
                        return _t1103
                    _t1104 = _t1102(msg)
                    deconstruct_result344 = _t1104
                    
                    if deconstruct_result344 is not None:
                        _t1106 = self.pretty_sum_monoid(deconstruct_result344)
                        _t1105 = _t1106
                    else:
    ...
    def pretty_min_monoid(self, msg: logic_pb2.MinMonoid) -> Optional[Never]:
        ...
        self.indent()
        self.newline()
        _t1111 = self.pretty_type(unwrapped_fields351)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_max_monoid(self, msg: logic_pb2.MaxMonoid) -> Optional[Never]:
        ...
        self.indent()
        self.newline()
        _t1114 = self.pretty_type(unwrapped_fields353)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_sum_monoid(self, msg: logic_pb2.SumMonoid) -> Optional[Never]:
        ...
        self.indent()
        self.newline()
        _t1117 = self.pretty_type(unwrapped_fields355)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_monus_def(self, msg: logic_pb2.MonusDef) -> Optional[Never]:
        ...
        _t1121 = self.pretty_monoid(field358)
        self.newline()
        field359 = unwrapped_fields357[1]
        _t1122 = self.pretty_relation_id(field359)
        self.newline()
        field360 = unwrapped_fields357[2]
        _t1123 = self.pretty_abstraction_with_arity(field360)
        ...
        if field361 is not None:
            ...
            opt_val362 = field361
            _t1125 = self.pretty_attrs(opt_val362)
            _t1124 = _t1125
        else:
            _t1124 = None
        self.dedent()
    ...
    def pretty_constraint(self, msg: logic_pb2.Constraint) -> Optional[Never]:
        ...
        _t1128 = self.pretty_relation_id(field365)
        self.newline()
        field366 = unwrapped_fields364[1]
        _t1129 = self.pretty_abstraction(field366)
        self.newline()
        field367 = unwrapped_fields364[2]
        _t1130 = self.pretty_functional_dependency_keys(field367)
        self.newline()
        field368 = unwrapped_fields364[3]
        _t1131 = self.pretty_functional_dependency_values(field368)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields370) == 0:
            ...
            for i372, elem371 in enumerate(unwrapped_fields370):
                ...
                if (i372 > 0):
                    ...
                    _t1134 = None
                _t1135 = self.pretty_var(elem371)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields374) == 0:
            ...
            for i376, elem375 in enumerate(unwrapped_fields374):
                ...
                if (i376 > 0):
                    ...
                    _t1138 = None
                _t1139 = self.pretty_var(elem375)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_data(self, msg: logic_pb2.Data) -> Optional[Never]:
        def _t1140(_dollar_dollar):
            ...
            return _t1141
        _t1142 = _t1140(msg)
        deconstruct_result379 = _t1142
        
        if deconstruct_result379 is not None:
            _t1144 = self.pretty_rel_edb(deconstruct_result379)
            _t1143 = _t1144
        else:
            def _t1145(_dollar_dollar):
                ...
                return _t1146
            _t1147 = _t1145(msg)
            deconstruct_result378 = _t1147
            
            if deconstruct_result378 is not None:
                _t1149 = self.pretty_betree_relation(deconstruct_result378)
                _t1148 = _t1149
            else:
                def _t1150(_dollar_dollar):
                    ...
                    return _t1151
                _t1152 = _t1150(msg)
                deconstruct_result377 = _t1152
                
                if deconstruct_result377 is not None:
                    _t1154 = self.pretty_csv_data(deconstruct_result377)
                    _t1153 = _t1154
                else:
    ...
    def pretty_rel_edb(self, msg: logic_pb2.RelEDB) -> Optional[Never]:
        ...
        _t1157 = self.pretty_relation_id(field382)
        self.newline()
        field383 = unwrapped_fields381[1]
        _t1158 = self.pretty_rel_edb_path(field383)
        self.newline()
        field384 = unwrapped_fields381[2]
        _t1159 = self.pretty_rel_edb_types(field384)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_rel_edb_types(self, msg: list[logic_pb2.Type]) -> Optional[Never]:
        ...
        for i392, elem391 in enumerate(unwrapped_fields390):
            ...
            if (i392 > 0):
                ...
                _t1165 = None
            _t1166 = self.pretty_type(elem391)
        self.write(']')
        return None
    ...
    def pretty_betree_relation(self, msg: logic_pb2.BeTreeRelation) -> Optional[Never]:
        ...
        _t1169 = self.pretty_relation_id(field395)
        self.newline()
        field396 = unwrapped_fields394[1]
        _t1170 = self.pretty_betree_info(field396)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_betree_info(self, msg: logic_pb2.BeTreeInfo) -> Optional[Never]:
        ...
        _t1174 = self.pretty_betree_info_key_types(field399)
        self.newline()
        field400 = unwrapped_fields398[1]
        _t1175 = self.pretty_betree_info_value_types(field400)
        self.newline()
        field401 = unwrapped_fields398[2]
        _t1176 = self.pretty_config_dict(field401)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields403) == 0:
            ...
            for i405, elem404 in enumerate(unwrapped_fields403):
                ...
                if (i405 > 0):
                    ...
                    _t1179 = None
                _t1180 = self.pretty_type(elem404)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields407) == 0:
            ...
            for i409, elem408 in enumerate(unwrapped_fields407):
                ...
                if (i409 > 0):
                    ...
                    _t1183 = None
                _t1184 = self.pretty_type(elem408)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_csv_data(self, msg: logic_pb2.CSVData) -> Optional[Never]:
        ...
        _t1187 = self.pretty_csvlocator(field412)
        self.newline()
        field413 = unwrapped_fields411[1]
        _t1188 = self.pretty_csv_config(field413)
        self.newline()
        field414 = unwrapped_fields411[2]
        _t1189 = self.pretty_csv_columns(field414)
        self.newline()
        field415 = unwrapped_fields411[3]
        _t1190 = self.pretty_csv_asof(field415)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_csvlocator(self, msg: logic_pb2.CSVLocator) -> Optional[Never]:
        ...
        if field418 is not None:
            ...
            opt_val419 = field418
            _t1196 = self.pretty_csv_locator_paths(opt_val419)
            _t1195 = _t1196
        else:
            _t1195 = None
        ...
        if field420 is not None:
            ...
            opt_val421 = field420
            _t1198 = self.pretty_csv_locator_inline_data(opt_val421)
            _t1197 = _t1198
        else:
            _t1197 = None
        self.dedent()
    ...
    def pretty_csv_config(self, msg: logic_pb2.CSVConfig) -> Optional[Never]:
        ...
        self.indent()
        self.newline()
        _t1207 = self.pretty_config_dict(unwrapped_fields429)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields431) == 0:
            ...
            for i433, elem432 in enumerate(unwrapped_fields431):
                ...
                if (i433 > 0):
                    ...
                    _t1210 = None
                _t1211 = self.pretty_csv_column(elem432)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_csv_column(self, msg: logic_pb2.CSVColumn) -> Optional[Never]:
        ...
        _t1214 = self.pretty_relation_id(field437)
        self.newline()
        self.write('[')
        field438 = unwrapped_fields435[2]
        if not len(field438) == 0:
            self.newline()
            for i440, elem439 in enumerate(field438):
                ...
                if (i440 > 0):
                    ...
                    _t1215 = None
                _t1216 = self.pretty_type(elem439)
        self.write(']')
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_undefine(self, msg: transactions_pb2.Undefine) -> Optional[Never]:
        ...
        self.indent()
        self.newline()
        _t1221 = self.pretty_fragment_id(unwrapped_fields444)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields446) == 0:
            ...
            for i448, elem447 in enumerate(unwrapped_fields446):
                ...
                if (i448 > 0):
                    ...
                    _t1224 = None
                _t1225 = self.pretty_relation_id(elem447)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields450) == 0:
            ...
            for i452, elem451 in enumerate(unwrapped_fields450):
                ...
                if (i452 > 0):
                    ...
                    _t1228 = None
                _t1229 = self.pretty_read(elem451)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_read(self, msg: transactions_pb2.Read) -> Optional[Never]:
        def _t1230(_dollar_dollar):
            ...
            return _t1231
        _t1232 = _t1230(msg)
        deconstruct_result457 = _t1232
        
        if deconstruct_result457 is not None:
            _t1234 = self.pretty_demand(deconstruct_result457)
            _t1233 = _t1234
        else:
            def _t1235(_dollar_dollar):
                ...
                return _t1236
            _t1237 = _t1235(msg)
            deconstruct_result456 = _t1237
            
            if deconstruct_result456 is not None:
                _t1239 = self.pretty_output(deconstruct_result456)
                _t1238 = _t1239
            else:
                def _t1240(_dollar_dollar):
                    ...
                    return _t1241
                _t1242 = _t1240(msg)
                deconstruct_result455 = _t1242
                
                if deconstruct_result455 is not None:
                    _t1244 = self.pretty_what_if(deconstruct_result455)
                    _t1243 = _t1244
                else:
                    def _t1245(_dollar_dollar):
                        ...
                        return _t1246
                    _t1247 = _t1245(msg)
                    deconstruct_result454 = _t1247
                    
                    if deconstruct_result454 is not None:
                        _t1249 = self.pretty_abort(deconstruct_result454)
                        _t1248 = _t1249
                    else:
                        def _t1250(_dollar_dollar):
                            ...
                            return _t1251
                        _t1252 = _t1250(msg)
                        deconstruct_result453 = _t1252
                        
                        if deconstruct_result453 is not None:
                            _t1254 = self.pretty_export(deconstruct_result453)
                            _t1253 = _t1254
                        else:
    ...
    def pretty_demand(self, msg: transactions_pb2.Demand) -> Optional[Never]:
        ...
        self.indent()
        self.newline()
        _t1257 = self.pretty_relation_id(unwrapped_fields459)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_output(self, msg: transactions_pb2.Output) -> Optional[Never]:
        ...
        _t1260 = self.pretty_name(field462)
        self.newline()
        field463 = unwrapped_fields461[1]
        _t1261 = self.pretty_relation_id(field463)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_what_if(self, msg: transactions_pb2.WhatIf) -> Optional[Never]:
        ...
        _t1264 = self.pretty_name(field466)
        self.newline()
        field467 = unwrapped_fields465[1]
        _t1265 = self.pretty_epoch(field467)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_abort(self, msg: transactions_pb2.Abort) -> Optional[Never]:
        ...
        if field470 is not None:
            ...
            opt_val471 = field470
            _t1270 = self.pretty_name(opt_val471)
            _t1269 = _t1270
        else:
            _t1269 = None
        self.newline()
        field472 = unwrapped_fields469[1]
        _t1271 = self.pretty_relation_id(field472)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_export(self, msg: transactions_pb2.Export) -> Optional[Never]:
        ...
        self.indent()
        self.newline()
        _t1274 = self.pretty_export_csv_config(unwrapped_fields474)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_export_csv_config(self, msg: transactions_pb2.ExportCSVConfig) -> Optional[Never]:
        ...
        _t1278 = self.pretty_export_csv_path(field477)
        self.newline()
        field478 = unwrapped_fields476[1]
        _t1279 = self.pretty_export_csv_columns(field478)
        self.newline()
        field479 = unwrapped_fields476[2]
        _t1280 = self.pretty_config_dict(field479)
        self.dedent()
        self.write(')')
        return None
        ...
        if not len(unwrapped_fields483) == 0:
            ...
            for i485, elem484 in enumerate(unwrapped_fields483):
                ...
                if (i485 > 0):
                    ...
                    _t1285 = None
                _t1286 = self.pretty_export_csv_column(elem484)
        self.dedent()
        self.write(')')
        return None
    ...
    def pretty_export_csv_column(self, msg: transactions_pb2.ExportCSVColumn) -> Optional[Never]:
        ...
        _t1289 = self.pretty_relation_id(field489)
        self.dedent()
        self.write(')')
        return None
