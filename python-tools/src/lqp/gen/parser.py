...
class Parser:
    ...
    def _extract_value_float64(self, value: Optional[logic_pb2.Value], default: float) -> float:
        ...
        if value is not None:
            assert value is not None
            _t974 = value.HasField('float_value')
        else:
            _t974 = False
        if _t974:
            assert value is not None
    ...
    def _extract_value_string(self, value: Optional[logic_pb2.Value], default: str) -> str:
        ...
        if value is not None:
            assert value is not None
            _t975 = value.HasField('string_value')
        else:
            _t975 = False
        if _t975:
            assert value is not None
    ...
    def _extract_value_uint128(self, value: Optional[logic_pb2.Value], default: logic_pb2.UInt128Value) -> logic_pb2.UInt128Value:
        ...
        if value is not None:
            assert value is not None
            _t978 = value.HasField('uint128_value')
        else:
            _t978 = False
        if _t978:
            assert value is not None
    ...
    def _extract_value_string_list(self, value: Optional[logic_pb2.Value], default: Sequence[str]) -> Sequence[str]:
        ...
        if value is not None:
            assert value is not None
            _t979 = value.HasField('string_value')
        else:
            _t979 = False
        if _t979:
            assert value is not None
    ...
    def _try_extract_value_int64(self, value: Optional[logic_pb2.Value]) -> Optional[int]:
        ...
        if value is not None:
            assert value is not None
            _t980 = value.HasField('int_value')
        else:
            _t980 = False
        if _t980:
            assert value is not None
    ...
    def _try_extract_value_float64(self, value: Optional[logic_pb2.Value]) -> Optional[float]:
        ...
        if value is not None:
            assert value is not None
            _t981 = value.HasField('float_value')
        else:
            _t981 = False
        if _t981:
            assert value is not None
    ...
    def _try_extract_value_bytes(self, value: Optional[logic_pb2.Value]) -> Optional[bytes]:
        ...
        if value is not None:
            assert value is not None
            _t983 = value.HasField('string_value')
        else:
            _t983 = False
        if _t983:
            assert value is not None
    ...
    def _try_extract_value_uint128(self, value: Optional[logic_pb2.Value]) -> Optional[logic_pb2.UInt128Value]:
        ...
        if value is not None:
            assert value is not None
            _t984 = value.HasField('uint128_value')
        else:
            _t984 = False
        if _t984:
            assert value is not None
    ...
    def construct_csv_config(self, config_dict: Sequence[tuple[str, logic_pb2.Value]]) -> logic_pb2.CSVConfig:
        ...
        _t986 = self._extract_value_int32(config.get('csv_header_row'), 1)
        header_row = _t986
        _t987 = self._extract_value_int64(config.get('csv_skip'), 0)
        skip = _t987
        _t988 = self._extract_value_string(config.get('csv_new_line'), '')
        new_line = _t988
        _t989 = self._extract_value_string(config.get('csv_delimiter'), ',')
        delimiter = _t989
        _t990 = self._extract_value_string(config.get('csv_quotechar'), '"')
        quotechar = _t990
        _t991 = self._extract_value_string(config.get('csv_escapechar'), '"')
        escapechar = _t991
        _t992 = self._extract_value_string(config.get('csv_comment'), '')
        comment = _t992
        _t993 = self._extract_value_string_list(config.get('csv_missing_strings'), [])
        missing_strings = _t993
        _t994 = self._extract_value_string(config.get('csv_decimal_separator'), '.')
        decimal_separator = _t994
        _t995 = self._extract_value_string(config.get('csv_encoding'), 'utf-8')
        encoding = _t995
        _t996 = self._extract_value_string(config.get('csv_compression'), 'auto')
        compression = _t996
        _t997 = self._extract_value_int64(config.get('partition_size'), 0)
        partition_size = _t997
        _t998 = logic_pb2.CSVConfig(header_row=header_row, skip=skip, new_line=new_line, delimiter=delimiter, quotechar=quotechar, escapechar=escapechar, comment=comment, missing_strings=missing_strings, decimal_separator=decimal_separator, encoding=encoding, compression=compression, partition_size=partition_size)
        return _t998
    ...
    def construct_betree_info(self, key_types: Sequence[logic_pb2.Type], value_types: Sequence[logic_pb2.Type], config_dict: Sequence[tuple[str, logic_pb2.Value]]) -> logic_pb2.BeTreeInfo:
        config = dict(config_dict)
        _t999 = self._try_extract_value_float64(config.get('betree_config_epsilon'))
        epsilon = _t999
        _t1000 = self._try_extract_value_int64(config.get('betree_config_max_pivots'))
        max_pivots = _t1000
        _t1001 = self._try_extract_value_int64(config.get('betree_config_max_deltas'))
        max_deltas = _t1001
        _t1002 = self._try_extract_value_int64(config.get('betree_config_max_leaf'))
        max_leaf = _t1002
        _t1003 = logic_pb2.BeTreeConfig(epsilon=epsilon, max_pivots=max_pivots, max_deltas=max_deltas, max_leaf=max_leaf)
        storage_config = _t1003
        _t1004 = self._try_extract_value_uint128(config.get('betree_locator_root_pageid'))
        root_pageid = _t1004
        _t1005 = self._try_extract_value_bytes(config.get('betree_locator_inline_data'))
        inline_data = _t1005
        _t1006 = self._try_extract_value_int64(config.get('betree_locator_element_count'))
        element_count = _t1006
        _t1007 = self._try_extract_value_int64(config.get('betree_locator_tree_height'))
        tree_height = _t1007
        _t1008 = logic_pb2.BeTreeLocator(root_pageid=root_pageid, inline_data=inline_data, element_count=element_count, tree_height=tree_height)
        relation_locator = _t1008
        _t1009 = logic_pb2.BeTreeInfo(key_types=key_types, value_types=value_types, storage_config=storage_config, relation_locator=relation_locator)
        return _t1009

    def default_configure(self) -> transactions_pb2.Configure:
        _t1010 = transactions_pb2.IVMConfig(level=transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_OFF)
        ivm_config = _t1010
        _t1011 = transactions_pb2.Configure(semantics_version=0, ivm_config=ivm_config)
        return _t1011
            ...
            if maintenance_level_val.string_value == 'off':
                ...
                if maintenance_level_val.string_value == 'auto':
                    ...
                    if maintenance_level_val.string_value == 'all':
                        ...
                        maintenance_level = transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_OFF
        _t1012 = transactions_pb2.IVMConfig(level=maintenance_level)
        ivm_config = _t1012
        _t1013 = self._extract_value_int64(config.get('semantics_version'), 0)
        semantics_version = _t1013
        _t1014 = transactions_pb2.Configure(semantics_version=semantics_version, ivm_config=ivm_config)
        return _t1014
    ...
    def construct_export_csv_config(self, path: str, columns: Sequence[transactions_pb2.ExportCSVColumn], config_dict: Sequence[tuple[str, logic_pb2.Value]]) -> transactions_pb2.ExportCSVConfig:
        config = dict(config_dict)
        _t1015 = self._extract_value_int64(config.get('partition_size'), 0)
        partition_size = _t1015
        _t1016 = self._extract_value_string(config.get('compression'), '')
        compression = _t1016
        _t1017 = self._extract_value_boolean(config.get('syntax_header_row'), True)
        syntax_header_row = _t1017
        _t1018 = self._extract_value_string(config.get('syntax_missing_string'), '')
        syntax_missing_string = _t1018
        _t1019 = self._extract_value_string(config.get('syntax_delim'), ',')
        syntax_delim = _t1019
        _t1020 = self._extract_value_string(config.get('syntax_quotechar'), '"')
        syntax_quotechar = _t1020
        _t1021 = self._extract_value_string(config.get('syntax_escapechar'), '\\')
        syntax_escapechar = _t1021
        _t1022 = transactions_pb2.ExportCSVConfig(path=path, data_columns=columns, partition_size=partition_size, compression=compression, syntax_header_row=syntax_header_row, syntax_missing_string=syntax_missing_string, syntax_delim=syntax_delim, syntax_quotechar=syntax_quotechar, syntax_escapechar=syntax_escapechar)
        return _t1022
    ...
    def deconstruct_configure(self, msg: transactions_pb2.Configure) -> list[tuple[str, logic_pb2.Value]]:
        ...
        if msg.ivm_config.level == transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_AUTO:
            _t1030 = self._make_value_string('auto')
            result.append(('ivm.maintenance_level', _t1030,))
        else:
            if msg.ivm_config.level == transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_ALL:
                _t1031 = self._make_value_string('all')
                result.append(('ivm.maintenance_level', _t1031,))
            else:
                if msg.ivm_config.level == transactions_pb2.MaintenanceLevel.MAINTENANCE_LEVEL_OFF:
                    _t1032 = self._make_value_string('off')
                    result.append(('ivm.maintenance_level', _t1032,))
        _t1033 = self._make_value_int64(msg.semantics_version)
        result.append(('semantics_version', _t1033,))
        return sorted(result)

    def deconstruct_csv_config(self, msg: logic_pb2.CSVConfig) -> list[tuple[str, logic_pb2.Value]]:
        result = []
        _t1034 = self._make_value_int32(msg.header_row)
        result.append(('csv_header_row', _t1034,))
        _t1035 = self._make_value_int64(msg.skip)
        result.append(('csv_skip', _t1035,))
        if msg.new_line != '':
            _t1036 = self._make_value_string(msg.new_line)
            result.append(('csv_new_line', _t1036,))
        _t1037 = self._make_value_string(msg.delimiter)
        result.append(('csv_delimiter', _t1037,))
        _t1038 = self._make_value_string(msg.quotechar)
        result.append(('csv_quotechar', _t1038,))
        _t1039 = self._make_value_string(msg.escapechar)
        result.append(('csv_escapechar', _t1039,))
        if msg.comment != '':
            _t1040 = self._make_value_string(msg.comment)
            result.append(('csv_comment', _t1040,))
        for missing_string in msg.missing_strings:
            _t1041 = self._make_value_string(missing_string)
            result.append(('csv_missing_strings', _t1041,))
        _t1042 = self._make_value_string(msg.decimal_separator)
        result.append(('csv_decimal_separator', _t1042,))
        _t1043 = self._make_value_string(msg.encoding)
        result.append(('csv_encoding', _t1043,))
        _t1044 = self._make_value_string(msg.compression)
        result.append(('csv_compression', _t1044,))
        if msg.partition_size != 0:
            _t1045 = self._make_value_int64(msg.partition_size)
            result.append(('csv_partition_size', _t1045,))
        return sorted(result)

    def deconstruct_betree_info_config(self, msg: logic_pb2.BeTreeInfo) -> list[tuple[str, logic_pb2.Value]]:
        result = []
        _t1046 = self._make_value_float64(msg.storage_config.epsilon)
        result.append(('betree_config_epsilon', _t1046,))
        _t1047 = self._make_value_int64(msg.storage_config.max_pivots)
        result.append(('betree_config_max_pivots', _t1047,))
        _t1048 = self._make_value_int64(msg.storage_config.max_deltas)
        result.append(('betree_config_max_deltas', _t1048,))
        _t1049 = self._make_value_int64(msg.storage_config.max_leaf)
        result.append(('betree_config_max_leaf', _t1049,))
        if msg.relation_locator.HasField('root_pageid'):
            if msg.relation_locator.root_pageid is not None:
                ...
                _t1050 = self._make_value_uint128(msg.relation_locator.root_pageid)
                result.append(('betree_locator_root_pageid', _t1050,))
        if msg.relation_locator.HasField('inline_data'):
            if msg.relation_locator.inline_data is not None:
                ...
                _t1051 = self._make_value_string(msg.relation_locator.inline_data.decode('utf-8'))
                result.append(('betree_locator_inline_data', _t1051,))
        _t1052 = self._make_value_int64(msg.relation_locator.element_count)
        result.append(('betree_locator_element_count', _t1052,))
        _t1053 = self._make_value_int64(msg.relation_locator.tree_height)
        result.append(('betree_locator_tree_height', _t1053,))
        return sorted(result)
    ...
    def deconstruct_export_csv_config(self, msg: transactions_pb2.ExportCSVConfig) -> list[tuple[str, logic_pb2.Value]]:
        ...
        if msg.partition_size is not None:
            ...
            _t1054 = self._make_value_int64(msg.partition_size)
            result.append(('partition_size', _t1054,))
        if msg.compression is not None:
            assert msg.compression is not None
            _t1055 = self._make_value_string(msg.compression)
            result.append(('compression', _t1055,))
        if msg.syntax_header_row is not None:
            assert msg.syntax_header_row is not None
            _t1056 = self._make_value_boolean(msg.syntax_header_row)
            result.append(('syntax_header_row', _t1056,))
        if msg.syntax_missing_string is not None:
            assert msg.syntax_missing_string is not None
            _t1057 = self._make_value_string(msg.syntax_missing_string)
            result.append(('syntax_missing_string', _t1057,))
        if msg.syntax_delim is not None:
            assert msg.syntax_delim is not None
            _t1058 = self._make_value_string(msg.syntax_delim)
            result.append(('syntax_delim', _t1058,))
        if msg.syntax_quotechar is not None:
            ...
            result.append(('syntax_quotechar', _t1059,))
        if msg.syntax_escapechar is not None:
            assert msg.syntax_escapechar is not None
            _t1060 = self._make_value_string(msg.syntax_escapechar)
            result.append(('syntax_escapechar', _t1060,))
        return sorted(result)
